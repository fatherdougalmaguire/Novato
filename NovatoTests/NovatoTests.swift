...
struct Z80Opcodes: testHelper
{
    ...
    struct primaryOpcodesFlags
    {
        ...
        @Test("Validate INC B (0x04)",  arguments: loadJsonTests(named: "04").prefix(testCycles))
        func test_INC_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC B (0x05)",  arguments: loadJsonTests(named: "05").prefix(testCycles))
        func test_DEC_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLCA (0x07)",  arguments: loadJsonTests(named: "07").prefix(testCycles))
        func test_RLCA(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD HL,BC (0x09)",  arguments: loadJsonTests(named: "09").prefix(testCycles))
        func test_ADD_HL_BC(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC C (0x0C)",  arguments: loadJsonTests(named: "0c").prefix(testCycles))
        func test_INC_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC C (0x0D)",  arguments: loadJsonTests(named: "0d").prefix(testCycles))
        func test_DEC_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRCA (0x0F)",  arguments: loadJsonTests(named: "0f").prefix(testCycles))
        func test_RRCA(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC D (0x14)",  arguments: loadJsonTests(named: "14").prefix(testCycles))
        func test_INC_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC D (0x15)",  arguments: loadJsonTests(named: "15").prefix(testCycles))
        func test_DEC_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLA (0x17)",  arguments: loadJsonTests(named: "17").prefix(testCycles))
        func test_RLA(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD HL,DE (0x19)",  arguments: loadJsonTests(named: "19").prefix(testCycles))
        func test_ADD_HL_DE(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC E (0x1C)",  arguments: loadJsonTests(named: "1c").prefix(testCycles))
        func test_INC_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC E (0x1D)",  arguments: loadJsonTests(named: "1d").prefix(testCycles))
        func test_DEC_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRA (0x1F)",  arguments: loadJsonTests(named: "1f").prefix(testCycles))
        func test_RRA(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC H (0x24)",  arguments: loadJsonTests(named: "24").prefix(testCycles))
        func test_INC_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC H (0x25)",  arguments: loadJsonTests(named: "25").prefix(testCycles))
        func test_DEC_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DAA (0x27)",  arguments: loadJsonTests(named: "27").prefix(testCycles))
        func test_DAA(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD HL,HL (0x29)",  arguments: loadJsonTests(named: "29").prefix(testCycles))
        func test_ADD_HL_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC L (0x2C)",  arguments: loadJsonTests(named: "2c").prefix(testCycles))
        func test_INC_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC L (0x2D)",  arguments: loadJsonTests(named: "2d").prefix(testCycles))
        func test_DEC_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CPL (0x2F)",  arguments: loadJsonTests(named: "2f").prefix(testCycles))
        func test_CPL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC (HL) (0x34)",  arguments: loadJsonTests(named: "34").prefix(testCycles))
        func test_INC_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC (HL) (0x35)",  arguments: loadJsonTests(named: "35").prefix(testCycles))
        func test_DEC_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SCF (0x37)",  arguments: loadJsonTests(named: "37").prefix(testCycles))
        func test_SCF(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD HL,SP (0x39)",  arguments: loadJsonTests(named: "39").prefix(testCycles))
        func test_ADD_HL_SP(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate INC A (0x3C)",  arguments: loadJsonTests(named: "3c").prefix(testCycles))
        func test_INC_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate DEC A (0x3D)",  arguments: loadJsonTests(named: "3d").prefix(testCycles))
        func test_DEC_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CCF (0x3F)",  arguments: loadJsonTests(named: "3f").prefix(testCycles))
        func test_CCF(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,B (0x80)",  arguments: loadJsonTests(named: "80").prefix(testCycles))
        func test_ADD_A_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,C (0x81)",  arguments: loadJsonTests(named: "81").prefix(testCycles))
        func test_ADD_A_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,D (0x82)",  arguments: loadJsonTests(named: "82").prefix(testCycles))
        func test_ADD_A_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,E (0x83)",  arguments: loadJsonTests(named: "83").prefix(testCycles))
        func test_ADD_A_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,H (0x84)",  arguments: loadJsonTests(named: "84").prefix(testCycles))
        func test_ADD_A_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,L (0x85)",  arguments: loadJsonTests(named: "85").prefix(testCycles))
        func test_ADD_A_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,(HL) (0x86)",  arguments: loadJsonTests(named: "86").prefix(testCycles))
        func test_ADD_A_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,A (0x87)",  arguments: loadJsonTests(named: "87").prefix(testCycles))
        func test_ADD_A_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,B (0x88)",  arguments: loadJsonTests(named: "88").prefix(testCycles))
        func test_ADC_A_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,C (0x89)",  arguments: loadJsonTests(named: "89").prefix(testCycles))
        func test_ADC_A_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,D (0x8A)",  arguments: loadJsonTests(named: "8a").prefix(testCycles))
        func test_ADC_A_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,E (0x8B)",  arguments: loadJsonTests(named: "8b").prefix(testCycles))
        func test_ADC_A_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,H (0x8C)",  arguments: loadJsonTests(named: "8c").prefix(testCycles))
        func test_ADC_A_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,L (0x8D)",  arguments: loadJsonTests(named: "8d").prefix(testCycles))
        func test_ADC_A_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,(HL) (0x8E)",  arguments: loadJsonTests(named: "8e").prefix(testCycles))
        ...
        @Test("Validate SUB B (0x90)",  arguments: loadJsonTests(named: "90").prefix(testCycles))
        func test_SUB_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB C (0x91)",  arguments: loadJsonTests(named: "91").prefix(testCycles))
        func test_SUB_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB D (0x92)",  arguments: loadJsonTests(named: "92").prefix(testCycles))
        func test_SUB_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB E (0x93)",  arguments: loadJsonTests(named: "93").prefix(testCycles))
        func test_SUB_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB H (0x94)",  arguments: loadJsonTests(named: "94").prefix(testCycles))
        func test_SUB_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB L (0x95)",  arguments: loadJsonTests(named: "95").prefix(testCycles))
        func test_SUB_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB (HL) (0x96)",  arguments: loadJsonTests(named: "96").prefix(testCycles))
        func test_SUB_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB A (0x97)",  arguments: loadJsonTests(named: "97").prefix(testCycles))
        func test_SUB_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,B (0x98)",  arguments: loadJsonTests(named: "98").prefix(testCycles))
        func test_SBC_A_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,C (0x99)",  arguments: loadJsonTests(named: "99").prefix(testCycles))
        func test_SBC_A_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,D (0x9A)",  arguments: loadJsonTests(named: "9a").prefix(testCycles))
        func test_SBC_A_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,E (0x9B)",  arguments: loadJsonTests(named: "9b").prefix(testCycles))
        func test_SBC_A_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,H (0x9C)",  arguments: loadJsonTests(named: "9c").prefix(testCycles))
        func test_SBC_A_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,L (0x9D)",  arguments: loadJsonTests(named: "9d").prefix(testCycles))
        func test_SBC_A_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,(HL) (0x9E)",  arguments: loadJsonTests(named: "9e").prefix(testCycles))
        func test_SBC_A_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,A (0x9F)",  arguments: loadJsonTests(named: "9f").prefix(testCycles))
        func test_SBC_A_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND B (0xA0)",  arguments: loadJsonTests(named: "a0").prefix(testCycles))
        func test_AND_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND C (0xA1)",  arguments: loadJsonTests(named: "a1").prefix(testCycles))
        func test_AND_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND D (0xA2)",  arguments: loadJsonTests(named: "a2").prefix(testCycles))
        func test_AND_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND E (0xA3)",  arguments: loadJsonTests(named: "a3").prefix(testCycles))
        func test_AND_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND H (0xA4)",  arguments: loadJsonTests(named: "a4").prefix(testCycles))
        func test_AND_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND L (0xA5)",  arguments: loadJsonTests(named: "a5").prefix(testCycles))
        func test_AND_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND (HL) (0xA6)",  arguments: loadJsonTests(named: "a6").prefix(testCycles))
        func test_AND_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND A (0xA7)",  arguments: loadJsonTests(named: "a7").prefix(testCycles))
        func test_AND_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR B (0xA8)",  arguments: loadJsonTests(named: "a8").prefix(testCycles))
        func test_XOR_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR C (0xA9)",  arguments: loadJsonTests(named: "a9").prefix(testCycles))
        func test_XOR_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR D (0xAA)",  arguments: loadJsonTests(named: "aa").prefix(testCycles))
        func test_XOR_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR E (0xAB)",  arguments: loadJsonTests(named: "ab").prefix(testCycles))
        func test_XOR_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR H (0xAC)",  arguments: loadJsonTests(named: "ac").prefix(testCycles))
        func test_XOR_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR L (0xAD)",  arguments: loadJsonTests(named: "ad").prefix(testCycles))
        func test_XOR_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR (HL) (0xAE)",  arguments: loadJsonTests(named: "ae").prefix(testCycles))
        func test_XOR_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate XOR A (0xAF)",  arguments: loadJsonTests(named: "af").prefix(testCycles))
        func test_XOR_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR B (0xB0)",  arguments: loadJsonTests(named: "b0").prefix(testCycles))
        func test_OR_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR C (0xB1)",  arguments: loadJsonTests(named: "b1").prefix(testCycles))
        func test_OR_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR D (0xB2)",  arguments: loadJsonTests(named: "b2").prefix(testCycles))
        func test_OR_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR E (0xB3)",  arguments: loadJsonTests(named: "b3").prefix(testCycles))
        func test_OR_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR H (0xB4)",  arguments: loadJsonTests(named: "b4").prefix(testCycles))
        func test_OR_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR L (0xB5)",  arguments: loadJsonTests(named: "b5").prefix(testCycles))
        func test_OR_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR (HL) (0xB6)",  arguments: loadJsonTests(named: "b6").prefix(testCycles))
        func test_OR_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate OR A (0xB7)",  arguments: loadJsonTests(named: "b7").prefix(testCycles))
        func test_OR_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP B (0xB8)",  arguments: loadJsonTests(named: "b8").prefix(testCycles))
        func test_CP_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP C (0xB9)",  arguments: loadJsonTests(named: "b9").prefix(testCycles))
        func test_CP_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP D (0xBA)",  arguments: loadJsonTests(named: "ba").prefix(testCycles))
        func test_CP_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP E (0xBB)",  arguments: loadJsonTests(named: "bb").prefix(testCycles))
        func test_CP_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP H (0xBC)",  arguments: loadJsonTests(named: "bc").prefix(testCycles))
        func test_CP_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP L (0xBD)",  arguments: loadJsonTests(named: "bd").prefix(testCycles))
        func test_CP_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP (HL) (0xBE)",  arguments: loadJsonTests(named: "be").prefix(testCycles))
        func test_CP_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate CP A (0xBF)",  arguments: loadJsonTests(named: "bf").prefix(testCycles))
        func test_CP_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADD A,$n (0xC6)",  arguments: loadJsonTests(named: "c6").prefix(testCycles))
        func test_ADD_A_N(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate ADC A,$n (0xCE)",  arguments: loadJsonTests(named: "ce").prefix(testCycles))
        func test_ADC_A_N(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SUB $n (0xD6)",  arguments: loadJsonTests(named: "d6").prefix(testCycles))
        func test_SUB_N(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SBC A,$n (0xDE)",  arguments: loadJsonTests(named: "de").prefix(testCycles))
        func test_SBC_A_N(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate AND $n (0xE6)",  arguments: loadJsonTests(named: "e6").prefix(testCycles))
        ...
        @Test("Validate OR $n (0xF6)",  arguments: loadJsonTests(named: "f6").prefix(testCycles))
        ...
        @Test("Validate CP $n (0xFE)",  arguments: loadJsonTests(named: "fe").prefix(testCycles))
    ...
    struct ExtendedOpcodesFlagsCB: testHelper
    {
        ...
        @Test("Validate RLC B (0xCB00)",  arguments: loadJsonTests(named: "cb 00").prefix(testCycles))
        func test_RLC_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC C (0xCB01)",  arguments: loadJsonTests(named: "cb 01").prefix(testCycles))
        func test_RLC_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC D (0xCB02)",  arguments: loadJsonTests(named: "cb 02").prefix(testCycles))
        func test_RLC_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC E (0xCB03)",  arguments: loadJsonTests(named: "cb 03").prefix(testCycles))
        func test_RLC_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC H (0xCB04)",  arguments: loadJsonTests(named: "cb 04").prefix(testCycles))
        func test_RLC_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC L (0xCB05)",  arguments: loadJsonTests(named: "cb 05").prefix(testCycles))
        func test_RLC_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC (HL) (0xCB06)",  arguments: loadJsonTests(named: "cb 06").prefix(testCycles))
        func test_RLC_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RLC A (0xCB07)",  arguments: loadJsonTests(named: "cb 07").prefix(testCycles))
        func test_RLC_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC B (0xCB08)",  arguments: loadJsonTests(named: "cb 08").prefix(testCycles))
        func test_RRC_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC C (0xCB09)",  arguments: loadJsonTests(named: "cb 09").prefix(testCycles))
        func test_RRC_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC D (0xCB0A)",  arguments: loadJsonTests(named: "cb 0a").prefix(testCycles))
        func test_RRC_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC E (0xCB0B)",  arguments: loadJsonTests(named: "cb 0b").prefix(testCycles))
        func test_RRC_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC H (0xCB0C)",  arguments: loadJsonTests(named: "cb 0c").prefix(testCycles))
        func test_RRC_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC L (0xCB0D)",  arguments: loadJsonTests(named: "cb 0d").prefix(testCycles))
        func test_RRC_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC (HL) (0xCB0E)",  arguments: loadJsonTests(named: "cb 0e").prefix(testCycles))
        func test_RRC_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC A (0xCB0F)",  arguments: loadJsonTests(named: "cb 0f").prefix(testCycles))
        func test_RRC_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL B (0xCB10)",  arguments: loadJsonTests(named: "cb 10").prefix(testCycles))
        func test_RL_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL C (0xCB11)",  arguments: loadJsonTests(named: "cb 11").prefix(testCycles))
        func test_RL_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL D (0xCB12)",  arguments: loadJsonTests(named: "cb 12").prefix(testCycles))
        func test_RL_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL E (0xCB13)",  arguments: loadJsonTests(named: "cb 13").prefix(testCycles))
        func test_RL_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL H (0xCB14)",  arguments: loadJsonTests(named: "cb 14").prefix(testCycles))
        func test_RL_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL L (0xCB15)",  arguments: loadJsonTests(named: "cb 15").prefix(testCycles))
        func test_RL_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL (HL) (0xCB16)",  arguments: loadJsonTests(named: "cb 16").prefix(testCycles))
        func test_RL_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL A (0xCB17)",  arguments: loadJsonTests(named: "cb 17").prefix(testCycles))
        func test_RL_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR B (0xCB18)",  arguments: loadJsonTests(named: "cb 18").prefix(testCycles))
        func test_RR_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR C (0xCB19)",  arguments: loadJsonTests(named: "cb 19").prefix(testCycles))
        func test_RR_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR D (0xCB1A)",  arguments: loadJsonTests(named: "cb 1a").prefix(testCycles))
        func test_RR_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR E (0xCB1B)",  arguments: loadJsonTests(named: "cb 1b").prefix(testCycles))
        func test_RR_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR H (0xCB1C)",  arguments: loadJsonTests(named: "cb 1c").prefix(testCycles))
        func test_RR_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR L (0xCB1D)",  arguments: loadJsonTests(named: "cb 1d").prefix(testCycles))
        func test_RR_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR (HL) (0xCB1E)",  arguments: loadJsonTests(named: "cb 1e").prefix(testCycles))
        func test_RR_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR A (0xCB1F)",  arguments: loadJsonTests(named: "cb 1f").prefix(testCycles))
        func test_RR_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA B (0xCB20)",  arguments: loadJsonTests(named: "cb 20").prefix(testCycles))
        func test_SLA_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA C (0xCB21)",  arguments: loadJsonTests(named: "cb 21").prefix(testCycles))
        func test_SLA_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA D (0xCB22)",  arguments: loadJsonTests(named: "cb 22").prefix(testCycles))
        func test_SLA_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA E (0xCB23)",  arguments: loadJsonTests(named: "cb 23").prefix(testCycles))
        func test_SLA_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA H (0xCB24)",  arguments: loadJsonTests(named: "cb 24").prefix(testCycles))
        func test_SLA_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA L (0xCB25)",  arguments: loadJsonTests(named: "cb 25").prefix(testCycles))
        func test_SLA_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA (HL) (0xCB26)",  arguments: loadJsonTests(named: "cb 26").prefix(testCycles))
        func test_SLA_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA A (0xCB27)",  arguments: loadJsonTests(named: "cb 27").prefix(testCycles))
        func test_SLA_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA B (0xCB28)",  arguments: loadJsonTests(named: "cb 28").prefix(testCycles))
        func test_SRA_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA C (0xCB29)",  arguments: loadJsonTests(named: "cb 29").prefix(testCycles))
        func test_SRA_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA D (0xCB2A)",  arguments: loadJsonTests(named: "cb 2a").prefix(testCycles))
        func test_SRA_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA E (0xCB2B)",  arguments: loadJsonTests(named: "cb 2b").prefix(testCycles))
        func test_SRA_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA H (0xCB2C)",  arguments: loadJsonTests(named: "cb 2c").prefix(testCycles))
        func test_SRA_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA L (0xCB2D)",  arguments: loadJsonTests(named: "cb 2d").prefix(testCycles))
        func test_SRA_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA (HL) (0xCB2E)",  arguments: loadJsonTests(named: "cb 2e").prefix(testCycles))
        func test_SRA_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA A (0xCB2F)",  arguments: loadJsonTests(named: "cb 2f").prefix(testCycles))
        func test_SRA_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL B (0xCB38)",  arguments: loadJsonTests(named: "cb 38").prefix(testCycles))
        func test_SRL_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL C (0xCB39)",  arguments: loadJsonTests(named: "cb 39").prefix(testCycles))
        func test_SRL_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL D (0xCB3A)",  arguments: loadJsonTests(named: "cb 3a").prefix(testCycles))
        func test_SRL_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL E (0xCB3B)",  arguments: loadJsonTests(named: "cb 3b").prefix(testCycles))
        ...
        @Test("Validate SRL L (0xCB3D)",  arguments: loadJsonTests(named: "cb 3d").prefix(testCycles))
        func test_SRL_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL (HL) (0xCB3E)",  arguments: loadJsonTests(named: "cb 3e").prefix(testCycles))
        func test_SRL_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL A (0xCB3F)",  arguments: loadJsonTests(named: "cb 3f").prefix(testCycles))
        func test_SRL_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,B (0xCB40)",  arguments: loadJsonTests(named: "cb 40").prefix(testCycles))
        func test_BIT_0_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,C (0xCB41)",  arguments: loadJsonTests(named: "cb 41").prefix(testCycles))
        func test_BIT_0_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,D (0xCB42)",  arguments: loadJsonTests(named: "cb 42").prefix(testCycles))
        func test_BIT_0_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,E (0xCB43)",  arguments: loadJsonTests(named: "cb 43").prefix(testCycles))
        func test_BIT_0_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,H (0xCB44)",  arguments: loadJsonTests(named: "cb 44").prefix(testCycles))
        func test_BIT_0_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,L (0xCB45)",  arguments: loadJsonTests(named: "cb 45").prefix(testCycles))
        func test_BIT_0_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,(HL) (0xCB46)",  arguments: loadJsonTests(named: "cb 46").prefix(testCycles))
        func test_BIT_0_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,A (0xCB47)",  arguments: loadJsonTests(named: "cb 47").prefix(testCycles))
        func test_BIT_0_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,B (0xCB48)",  arguments: loadJsonTests(named: "cb 48").prefix(testCycles))
        func test_BIT_1_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,C (0xCB49)",  arguments: loadJsonTests(named: "cb 49").prefix(testCycles))
        func test_BIT_1_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,D (0xCB4A)",  arguments: loadJsonTests(named: "cb 4a").prefix(testCycles))
        func test_BIT_1_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,E (0xCB4B)",  arguments: loadJsonTests(named: "cb 4b").prefix(testCycles))
        func test_BIT_1_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,H (0xCB4C)",  arguments: loadJsonTests(named: "cb 4c").prefix(testCycles))
        func test_BIT_1_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,L (0xCB4D)",  arguments: loadJsonTests(named: "cb 4d").prefix(testCycles))
        func test_BIT_1_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,(HL) (0xCB4E)",  arguments: loadJsonTests(named: "cb 4e").prefix(testCycles))
        ...
        @Test("Validate BIT 2,B (0xCB50)",  arguments: loadJsonTests(named: "cb 50").prefix(testCycles))
        func test_BIT_2_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,C (0xCB51)",  arguments: loadJsonTests(named: "cb 51").prefix(testCycles))
        func test_BIT_2_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,D (0xCB52)",  arguments: loadJsonTests(named: "cb 52").prefix(testCycles))
        func test_BIT_2_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,E (0xCB53)",  arguments: loadJsonTests(named: "cb 53").prefix(testCycles))
        func test_BIT_2_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,H (0xCB54)",  arguments: loadJsonTests(named: "cb 54").prefix(testCycles))
        func test_BIT_2_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,L (0xCB55)",  arguments: loadJsonTests(named: "cb 55").prefix(testCycles))
        func test_BIT_2_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,(HL) (0xCB56)",  arguments: loadJsonTests(named: "cb 56").prefix(testCycles))
        func test_BIT_2_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,A (0xCB57)",  arguments: loadJsonTests(named: "cb 57").prefix(testCycles))
        func test_BIT_2_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,B (0xCB58)",  arguments: loadJsonTests(named: "cb 58").prefix(testCycles))
        func test_BIT_3_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,C (0xCB59)",  arguments: loadJsonTests(named: "cb 59").prefix(testCycles))
        func test_BIT_3_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,D (0xCB5A)",  arguments: loadJsonTests(named: "cb 5a").prefix(testCycles))
        func test_BIT_3_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,E (0xCB5B)",  arguments: loadJsonTests(named: "cb 5b").prefix(testCycles))
        func test_BIT_3_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,H (0xCB5C)",  arguments: loadJsonTests(named: "cb 5c").prefix(testCycles))
        func test_BIT_3_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,L (0xCB5D)",  arguments: loadJsonTests(named: "cb 5d").prefix(testCycles))
        func test_BIT_3_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,(HL) (0xCB5E)",  arguments: loadJsonTests(named: "cb 5e").prefix(testCycles))
        func test_BIT_3_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,A (0xCB5F)",  arguments: loadJsonTests(named: "cb 5f").prefix(testCycles))
        func test_BIT_3_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,B (0xCB60)",  arguments: loadJsonTests(named: "cb 60").prefix(testCycles))
        func test_BIT_4_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,C (0xCB61)",  arguments: loadJsonTests(named: "cb 61").prefix(testCycles))
        func test_BIT_4_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,D (0xCB62)",  arguments: loadJsonTests(named: "cb 62").prefix(testCycles))
        func test_BIT_4_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,E (0xCB63)",  arguments: loadJsonTests(named: "cb 63").prefix(testCycles))
        func test_BIT_4_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,H (0xCB64)",  arguments: loadJsonTests(named: "cb 64").prefix(testCycles))
        func test_BIT_4_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,L (0xCB65)",  arguments: loadJsonTests(named: "cb 65").prefix(testCycles))
        func test_BIT_4_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,(HL) (0xCB66)",  arguments: loadJsonTests(named: "cb 66").prefix(testCycles))
        func test_BIT_4_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,A (0xCB67)",  arguments: loadJsonTests(named: "cb 67").prefix(testCycles))
        func test_BIT_4_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,B (0xCB68)",  arguments: loadJsonTests(named: "cb 68").prefix(testCycles))
        func test_BIT_5_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,C (0xCB69)",  arguments: loadJsonTests(named: "cb 69").prefix(testCycles))
        func test_BIT_5_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,D (0xCB6A)",  arguments: loadJsonTests(named: "cb 6a").prefix(testCycles))
        func test_BIT_5_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,E (0xCB6B)",  arguments: loadJsonTests(named: "cb 6b").prefix(testCycles))
        func test_BIT_5_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,H (0xCB6C)",  arguments: loadJsonTests(named: "cb 6c").prefix(testCycles))
        func test_BIT_5_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,L (0xCB6D)",  arguments: loadJsonTests(named: "cb 6d").prefix(testCycles))
        func test_BIT_5_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,(HL) (0xCB6E)",  arguments: loadJsonTests(named: "cb 6e").prefix(testCycles))
        func test_BIT_5_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,A (0xCB6F)",  arguments: loadJsonTests(named: "cb 6f").prefix(testCycles))
        func test_BIT_5_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,B (0xCB70)",  arguments: loadJsonTests(named: "cb 70").prefix(testCycles))
        func test_BIT_6_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,C (0xCB71)",  arguments: loadJsonTests(named: "cb 71").prefix(testCycles))
        func test_BIT_6_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,D (0xCB72)",  arguments: loadJsonTests(named: "cb 72").prefix(testCycles))
        func test_BIT_6_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,E (0xCB73)",  arguments: loadJsonTests(named: "cb 73").prefix(testCycles))
        func test_BIT_6_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,H (0xCB74)",  arguments: loadJsonTests(named: "cb 74").prefix(testCycles))
        func test_BIT_6_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,L (0xCB75)",  arguments: loadJsonTests(named: "cb 75").prefix(testCycles))
        func test_BIT_6_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,(HL) (0xCB76)",  arguments: loadJsonTests(named: "cb 76").prefix(testCycles))
        func test_BIT_6_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,A (0xCB77)",  arguments: loadJsonTests(named: "cb 77").prefix(testCycles))
        func test_BIT_6_A(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,B (0xCB78)",  arguments: loadJsonTests(named: "cb 78").prefix(testCycles))
        func test_BIT_7_B(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,C (0xCB79)",  arguments: loadJsonTests(named: "cb 79").prefix(testCycles))
        func test_BIT_7_C(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,D (0xCB7A)",  arguments: loadJsonTests(named: "cb 7a").prefix(testCycles))
        func test_BIT_7_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,E (0xCB7B)",  arguments: loadJsonTests(named: "cb 7b").prefix(testCycles))
        func test_BIT_7_E(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,H (0xCB7C)",  arguments: loadJsonTests(named: "cb 7c").prefix(testCycles))
        func test_BIT_7_H(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,L (0xCB7D)",  arguments: loadJsonTests(named: "cb 7d").prefix(testCycles))
        func test_BIT_7_L(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,(HL) (0xCB7E)",  arguments: loadJsonTests(named: "cb 7e").prefix(testCycles))
        func test_BIT_7_CON_HL(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,A (0xCB7F)",  arguments: loadJsonTests(named: "cb 7f").prefix(testCycles))
    ...
    struct ExtendedOpcodesDDCB: testHelper
    {
        ...
        @Test("Validate SET 4,(IX+$d) (0xDDCB__E6)",  arguments: loadJsonTests(named: "dd cb __ e6").prefix(testCycles))
    ...
    struct ExtendedOpcodesFlagsED: testHelper
    {
        ...
        @Test("Validate CPDR (0xED:B9)",  arguments: loadJsonTests(named: "ed b9").prefix(testCycles))
    ...
    struct ExtendedOpcodesFD: testHelper
    {
        ...
        @Test("Validate LD IY,$nn (0xFD21)", .timeLimit(.minutes(testTiming)), arguments: loadJsonTests(named: "fd 21").prefix(testCycles))
        func test_LD_IY_NN(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD ($nn),IY (0xFD22)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 22").prefix(testCycles))
        func test_LD_CON_NN_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC IY (0xFD23)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 23").prefix(testCycles))
        func test_INC_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IY,($nn) (0xFD2A)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 2a").prefix(testCycles))
        func test_LD_IY_CON_NN(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC IY (0xFD2B)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 2b").prefix(testCycles))
        func test_DEC_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),$n (0xFD36)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 36").prefix(testCycles))
        func test_LD_CON_IY_D_$n(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,(IY+$d) (0xFD46)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 46").prefix(testCycles))
        func test_LD_B_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,(IY+$d) (0xFD4E)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 4e").prefix(testCycles))
        func test_LD_C_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,(IY+$d) (0xFD56)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 56").prefix(testCycles))
        func test_LD_D_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,(IY+$d) (0xFD5E)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 5e").prefix(testCycles))
        func test_LD_E_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD H,(IY+$d) (0xFD66)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 66").prefix(testCycles))
        func test_LD_H_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD L,(IY+$d) (0xFD6E)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 6e").prefix(testCycles))
        func test_LD_L_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),B (0xFD70)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 70").prefix(testCycles))
        func test_LD_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),C (0xFD71)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 71").prefix(testCycles))
        func test_LD_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),D (0xFD72)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 72").prefix(testCycles))
        func test_LD_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),E (0xFD73)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 73").prefix(testCycles))
        func test_LD_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),H (0xFD74)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 74").prefix(testCycles))
        func test_LD_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),L (0xFD75)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 75").prefix(testCycles))
        func test_LD_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD (IY+$d),A (0xFD77)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 77").prefix(testCycles))
        func test_LD_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,(IY+$d) (0xFD7E)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd 7e").prefix(testCycles))
        func test_LD_A_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate POP IY (0xFDE1)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd e1").prefix(testCycles))
        func test_POP_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate EX (SP),IY (0xFDE3)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd e3").prefix(testCycles))
        func test_EX_CON_SP_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate PUSH IY (0xFDE5)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd e5").prefix(testCycles))
        func test_PUSH_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate JP (IY) (0xFDE9)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd e9").prefix(testCycles))
        func test_JP_CON_IY(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD SP,IY (0xFDF9)", .timeLimit(.minutes(testTiming)),  arguments: loadJsonTests(named: "fd f9").prefix(testCycles))
    ...
    struct ExtendedOpcodesFlagsFDCB: testHelper
    {
        ...
        @Test("Validate RLC (IY+$d) (0xFDCB__06)",  arguments: loadJsonTests(named: "fd cb __ 06").prefix(testCycles))
        func test_RLC_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RRC (IY+$d) (0xFDCB__0E)",  arguments: loadJsonTests(named: "fd cb __ 0e").prefix(testCycles))
        func test_RRC_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RL (IY+$d) (0xFDCB__16)",  arguments: loadJsonTests(named: "fd cb __ 16").prefix(testCycles))
        func test_RL_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate RR (IY+$d) (0xFDCB__1E)",  arguments: loadJsonTests(named: "fd cb __ 1e").prefix(testCycles))
        func test_RR_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SLA (IY+$d) (0xFDCB__26)",  arguments: loadJsonTests(named: "fd cb __ 26").prefix(testCycles))
        func test_SLA_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRA (IY+$d) (0xFDCB__2E)",  arguments: loadJsonTests(named: "fd cb __ 2e").prefix(testCycles))
        func test_SRA_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate SRL (IY+$d) (0xFDCB__3E)",  arguments: loadJsonTests(named: "fd cb __ 3e").prefix(testCycles))
        func test_SRL_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 0,(IY+$d) (0xFDCB__46)",  arguments: loadJsonTests(named: "fd cb __ 46").prefix(testCycles))
        func test_BIT_0_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 1,(IY+$d) (0xFDCB__4E)",  arguments: loadJsonTests(named: "fd cb __ 4e").prefix(testCycles))
        func test_BIT_1_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 2,(IY+$d) (0xFDCB__56)",  arguments: loadJsonTests(named: "fd cb __ 56").prefix(testCycles))
        func test_BIT_2_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 3,(IY+$d) (0xFDCB__5E)",  arguments: loadJsonTests(named: "fd cb __ 5e").prefix(testCycles))
        func test_BIT_3_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 4,(IY+$d) (0xFDCB__66)",  arguments: loadJsonTests(named: "fd cb __ 66").prefix(testCycles))
        func test_BIT_4_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 5,(IY+$d) (0xFDCB__6E)",  arguments: loadJsonTests(named: "fd cb __ 6e").prefix(testCycles))
        func test_BIT_5_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 6,(IY+$d) (0xFDCB__76)",  arguments: loadJsonTests(named: "fd cb __ 76").prefix(testCycles))
        func test_BIT_6_CON_IY_D(testCase: Z80Test) async throws
        {
        try await parent.runTest(testCase)
        }

        @Test("Validate BIT 7,(IY+$d) (0xFDCB__7E)",  arguments: loadJsonTests(named: "fd cb __ 7e").prefix(testCycles))
    ...
    struct UndocumentExtendedOpcodesCB: testHelper
    {
        ...
        @Test("Validate SLL B (0xCB30)",  arguments: loadJsonTests(named: "cb 30").prefix(testCycles))
        func test_SLL_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL C (0xCB31)",  arguments: loadJsonTests(named: "cb 31").prefix(testCycles))
        func test_SLL_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL D (0xCB32)",  arguments: loadJsonTests(named: "cb 32").prefix(testCycles))
        func test_SLL_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL E (0xCB33)",  arguments: loadJsonTests(named: "cb 33").prefix(testCycles))
        func test_SLL_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL H (0xCB34)",  arguments: loadJsonTests(named: "cb 34").prefix(testCycles))
        func test_SLL_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL L (0xCB35)",  arguments: loadJsonTests(named: "cb 35").prefix(testCycles))
        func test_SLL_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (HL) (0xCB36)",  arguments: loadJsonTests(named: "cb 36").prefix(testCycles))
        func test_SLL_CON_HL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL A (0xCB37)",  arguments: loadJsonTests(named: "cb 37").prefix(testCycles))
    ...
    struct UndocumentExtendedOpcodesDD: testHelper
    {
        ...
        @Test("Validate INC B (0xDD04)",  arguments: loadJsonTests(named: "dd 04").prefix(testCycles))
        func test_INC_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC B (0xDD05)",  arguments: loadJsonTests(named: "dd 05").prefix(testCycles))
        func test_DEC_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,$n (0xDD06)",  arguments: loadJsonTests(named: "dd 06").prefix(testCycles))
        func test_LD_B_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC C (0xDD0C)",  arguments: loadJsonTests(named: "dd 0c").prefix(testCycles))
        func test_INC_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC C (0xDD0D)",  arguments: loadJsonTests(named: "dd 0d").prefix(testCycles))
        func test_DEC_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,$n (0xDD0E)",  arguments: loadJsonTests(named: "dd 0E").prefix(testCycles))
        func test_LD_C_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC D (0xDD14)",  arguments: loadJsonTests(named: "dd 14").prefix(testCycles))
        func test_INC_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC D (0xDD15)",  arguments: loadJsonTests(named: "dd 15").prefix(testCycles))
        func test_DEC_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,$n (0xDD16)",  arguments: loadJsonTests(named: "dd 16").prefix(testCycles))
        func test_LD_D_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC E (0xDD1C)",  arguments: loadJsonTests(named: "dd 1c").prefix(testCycles))
        func test_INC_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC E (0xDD1D)",  arguments: loadJsonTests(named: "dd 1d").prefix(testCycles))
        func test_DEC_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,$n (0xDD1E)",  arguments: loadJsonTests(named: "dd 1e").prefix(testCycles))
        func test_LD_E_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC IXH (0xDD24)",  arguments: loadJsonTests(named: "dd 24").prefix(testCycles))
        func test_INC_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC IXH (0xDD25)",  arguments: loadJsonTests(named: "dd 25").prefix(testCycles))
        func test_DEC_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IHX,$n (0xDD26)",  arguments: loadJsonTests(named: "dd 26").prefix(testCycles))
        func test_LD_IHX_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC IXL (0xDD2C)",  arguments: loadJsonTests(named: "dd 2c").prefix(testCycles))
        func test_INC_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC IXL (0xDD2D)",  arguments: loadJsonTests(named: "dd 2d").prefix(testCycles))
        func test_DEC_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,$n (0xDD2E)",  arguments: loadJsonTests(named: "dd 2e").prefix(testCycles))
        func test_LD_IXL_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC A (0xDD3C)",  arguments: loadJsonTests(named: "dd 3c").prefix(testCycles))
        func test_INC_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC A (0xDD3D)",  arguments: loadJsonTests(named: "dd 3d").prefix(testCycles))
        func test_DEC_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,$n (0xDD3E)",  arguments: loadJsonTests(named: "dd 3e").prefix(testCycles))
        func test_LD_A_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,B (0xDD40)",  arguments: loadJsonTests(named: "dd 40").prefix(testCycles))
        func test_LD_B_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,C (0xDD41)",  arguments: loadJsonTests(named: "dd 41").prefix(testCycles))
        func test_LD_B_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,D (0xDD42)",  arguments: loadJsonTests(named: "dd 42").prefix(testCycles))
        func test_LD_B_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,E (0xDD43)",  arguments: loadJsonTests(named: "dd 43").prefix(testCycles))
        func test_LD_B_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,IXH (0xDD44)",  arguments: loadJsonTests(named: "dd 44").prefix(testCycles))
        func test_LD_B_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,IXL (0xDD45)",  arguments: loadJsonTests(named: "dd 45").prefix(testCycles))
        func test_LD_B_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,A (0xDD47)",  arguments: loadJsonTests(named: "dd 47").prefix(testCycles))
        func test_LD_B_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,B (0xDD48)",  arguments: loadJsonTests(named: "dd 48").prefix(testCycles))
        func test_LD_C_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,C (0xDD49)",  arguments: loadJsonTests(named: "dd 49").prefix(testCycles))
        func test_LD_C_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,D (0xDD4A)",  arguments: loadJsonTests(named: "dd 4a").prefix(testCycles))
        func test_LD_C_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,E (0xDD4B)",  arguments: loadJsonTests(named: "dd 4b").prefix(testCycles))
        func test_LD_C_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,IXH (0xDD4C)",  arguments: loadJsonTests(named: "dd 4c").prefix(testCycles))
        func test_LD_C_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,IXL (0xDD4D)",  arguments: loadJsonTests(named: "dd 4d").prefix(testCycles))
        func test_LD_C_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,A (0xDD4F)",  arguments: loadJsonTests(named: "dd 4f").prefix(testCycles))
        func test_LD_C_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,B (0xDD50)",  arguments: loadJsonTests(named: "dd 50").prefix(testCycles))
        func test_LD_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,C (0xDD51)",  arguments: loadJsonTests(named: "dd 51").prefix(testCycles))
        func test_LD_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,D (0xDD52)",  arguments: loadJsonTests(named: "dd 52").prefix(testCycles))
        func test_LD_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,E (0xDD53)",  arguments: loadJsonTests(named: "dd 53").prefix(testCycles))
        func test_LD_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,IXH (0xDD54)",  arguments: loadJsonTests(named: "dd 54").prefix(testCycles))
        func test_LD_D_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,IXL (0xDD55)",  arguments: loadJsonTests(named: "dd 55").prefix(testCycles))
        func test_LD_D_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,A (0xDD57)",  arguments: loadJsonTests(named: "dd 57").prefix(testCycles))
        func test_LD_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,B (0xDD58)",  arguments: loadJsonTests(named: "dd 58").prefix(testCycles))
        func test_LD_E_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,C (0xDD59)",  arguments: loadJsonTests(named: "dd 59").prefix(testCycles))
        func test_LD_E_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,D (0xDD5A)",  arguments: loadJsonTests(named: "dd 5a").prefix(testCycles))
        func test_LD_E_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,E (0xDD5B)",  arguments: loadJsonTests(named: "dd 5b").prefix(testCycles))
        func test_LD_E_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,IXH (0xDD5C)",  arguments: loadJsonTests(named: "dd 5c").prefix(testCycles))
        func test_LD_E_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,IXL (0xDD5D)",  arguments: loadJsonTests(named: "dd 5d").prefix(testCycles))
        func test_LD_E_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,A (0xDD5F)",  arguments: loadJsonTests(named: "dd 5f").prefix(testCycles))
        func test_LD_E_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,B (0xDD60)",  arguments: loadJsonTests(named: "dd 60").prefix(testCycles))
        func test_LD_IXH_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,C (0xDD61)",  arguments: loadJsonTests(named: "dd 61").prefix(testCycles))
        func test_LD_IXH_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,D (0xDD62)",  arguments: loadJsonTests(named: "dd 62").prefix(testCycles))
        func test_LD_IXH_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,E (0xDD63)",  arguments: loadJsonTests(named: "dd 63").prefix(testCycles))
        func test_LD_IXH_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,IXH (0xDD64)",  arguments: loadJsonTests(named: "dd 64").prefix(testCycles))
        func test_LD_IXH_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,IXL (0xDD65)",  arguments: loadJsonTests(named: "dd 65").prefix(testCycles))
        func test_LD_IXH_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXH,A (0xDD67)",  arguments: loadJsonTests(named: "dd 67").prefix(testCycles))
        func test_LD_IXH_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,B (0xDD68)",  arguments: loadJsonTests(named: "dd 68").prefix(testCycles))
        func test_LD_IXL_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,C (0xDD69)",  arguments: loadJsonTests(named: "dd 69").prefix(testCycles))
        func test_LD_IXL_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,D (0xDD6A)",  arguments: loadJsonTests(named: "dd 6a").prefix(testCycles))
        func test_LD_IXL_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,E (0xDD6B)",  arguments: loadJsonTests(named: "dd 6b").prefix(testCycles))
        func test_LD_IXL_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,IXH (0xDD6C)",  arguments: loadJsonTests(named: "dd 6c").prefix(testCycles))
        func test_LD_IXL_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,IXL (0xDD6D)",  arguments: loadJsonTests(named: "dd 6d").prefix(testCycles))
        func test_LD_IXL_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IXL,A (0xDD6F)",  arguments: loadJsonTests(named: "dd 6f").prefix(testCycles))
        func test_LD_IXL_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,B (0xDD78)",  arguments: loadJsonTests(named: "dd 78").prefix(testCycles))
        func test_LD_A_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,C (0xDD79)",  arguments: loadJsonTests(named: "dd 79").prefix(testCycles))
        func test_LD_A_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,D (0xDD7A)",  arguments: loadJsonTests(named: "dd 7a").prefix(testCycles))
        func test_LD_A_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,E (0xDD7B)",  arguments: loadJsonTests(named: "dd 7b").prefix(testCycles))
        func test_LD_A_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,IXH (0xDD7C)",  arguments: loadJsonTests(named: "dd 7c").prefix(testCycles))
        func test_LD_A_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,IXL (0xDD7D)",  arguments: loadJsonTests(named: "dd 7d").prefix(testCycles))
        func test_LD_A_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,A (0xDD7F)",  arguments: loadJsonTests(named: "dd 7f").prefix(testCycles))
        func test_LD_A_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,B (0xDD80)",  arguments: loadJsonTests(named: "dd 80").prefix(testCycles))
        func test_ADD_A_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,C (0xDD81)",  arguments: loadJsonTests(named: "dd 81").prefix(testCycles))
        func test_ADD_A_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,D (0xDD82)",  arguments: loadJsonTests(named: "dd 82").prefix(testCycles))
        func test_ADD_A_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,E (0xDD83)",  arguments: loadJsonTests(named: "dd 83").prefix(testCycles))
        func test_ADD_A_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,IXH (0xDD84)",  arguments: loadJsonTests(named: "dd 84").prefix(testCycles))
        func test_ADD_A_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,IXL (0xDD85)",  arguments: loadJsonTests(named: "dd 85").prefix(testCycles))
        func test_ADD_A_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,A (0xDD87)",  arguments: loadJsonTests(named: "dd 87").prefix(testCycles))
        func test_ADD_A_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,B (0xDD88)",  arguments: loadJsonTests(named: "dd 88").prefix(testCycles))
        func test_ADC_A_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,C (0xDD89)",  arguments: loadJsonTests(named: "dd 89").prefix(testCycles))
        func test_ADC_A_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,D (0xDD8A)",  arguments: loadJsonTests(named: "dd 8a").prefix(testCycles))
        func test_ADC_A_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,E (0xDD8B)",  arguments: loadJsonTests(named: "dd 8b").prefix(testCycles))
        func test_ADC_A_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,IXH (0xDD8C)",  arguments: loadJsonTests(named: "dd 8c").prefix(testCycles))
        func test_ADC_A_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,IXL (0xDD8D)",  arguments: loadJsonTests(named: "dd 8d").prefix(testCycles))
        func test_ADC_A_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,A (0xDD8F)",  arguments: loadJsonTests(named: "dd 8f").prefix(testCycles))
        func test_ADC_A_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB B (0xDD90)",  arguments: loadJsonTests(named: "dd 90").prefix(testCycles))
        func test_SUB_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB C (0xDD91)",  arguments: loadJsonTests(named: "dd 91").prefix(testCycles))
        func test_SUB_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB D (0xDD92)",  arguments: loadJsonTests(named: "dd 92").prefix(testCycles))
        func test_SUB_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB E (0xDD93)",  arguments: loadJsonTests(named: "dd 93").prefix(testCycles))
        func test_SUB_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB IXH (0xDD94)",  arguments: loadJsonTests(named: "dd 94").prefix(testCycles))
        func test_SUB_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB IXL (0xDD95)",  arguments: loadJsonTests(named: "dd 95").prefix(testCycles))
        func test_SUB_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB A (0xDD97)",  arguments: loadJsonTests(named: "dd 97").prefix(testCycles))
        func test_SUB_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,B (0xDD98)",  arguments: loadJsonTests(named: "dd 98").prefix(testCycles))
        func test_SBC_A_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,C (0xDD99)",  arguments: loadJsonTests(named: "dd 99").prefix(testCycles))
        func test_SBC_A_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,D (0xDD9A)",  arguments: loadJsonTests(named: "dd 9a").prefix(testCycles))
        func test_SBC_A_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,E (0xDD9B)",  arguments: loadJsonTests(named: "dd 9b").prefix(testCycles))
        func test_SBC_A_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,IXH (0xDD9C)",  arguments: loadJsonTests(named: "dd 9c").prefix(testCycles))
        func test_SBC_A_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,IXL (0xDD9D)",  arguments: loadJsonTests(named: "dd 9d").prefix(testCycles))
        func test_SBC_A_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,A (0xDD9F)",  arguments: loadJsonTests(named: "dd 9f").prefix(testCycles))
        func test_SBC_A_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND B (0xDDA0)",  arguments: loadJsonTests(named: "dd a0").prefix(testCycles))
        func test_AND_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND C (0xDDA1)",  arguments: loadJsonTests(named: "dd a1").prefix(testCycles))
        func test_AND_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND D (0xDDA2)",  arguments: loadJsonTests(named: "dd a2").prefix(testCycles))
        func test_AND_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND E (0xDDA3)",  arguments: loadJsonTests(named: "dd a3").prefix(testCycles))
        func test_AND_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND IXH (0xDDA4)",  arguments: loadJsonTests(named: "dd a4").prefix(testCycles))
        func test_AND_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND IXL (0xDDA5)",  arguments: loadJsonTests(named: "dd a5").prefix(testCycles))
        func test_AND_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND A (0xDDA7)",  arguments: loadJsonTests(named: "dd a7").prefix(testCycles))
        func test_AND_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR B (0xDDA8)",  arguments: loadJsonTests(named: "dd a8").prefix(testCycles))
        func test_XOR_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR C (0xDDA9)",  arguments: loadJsonTests(named: "dd a9").prefix(testCycles))
        func test_XOR_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR D (0xDDAA)",  arguments: loadJsonTests(named: "dd aa").prefix(testCycles))
        func test_XOR_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR E (0xDDAB)",  arguments: loadJsonTests(named: "dd ab").prefix(testCycles))
        func test_XOR_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR IXH (0xDDAC)",  arguments: loadJsonTests(named: "dd ac").prefix(testCycles))
        func test_XOR_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR IXL (0xDDAD)",  arguments: loadJsonTests(named: "dd ad").prefix(testCycles))
        func test_XOR_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR A (0xDDAF)",  arguments: loadJsonTests(named: "dd af").prefix(testCycles))
        func test_XOR_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR B (0xDDB0)",  arguments: loadJsonTests(named: "dd b0").prefix(testCycles))
        func test_OR_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR C (0xDDB1)",  arguments: loadJsonTests(named: "dd b1").prefix(testCycles))
        func test_OR_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR D (0xDDB2)",  arguments: loadJsonTests(named: "dd b2").prefix(testCycles))
        func test_OR_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR E (0xDDB3)",  arguments: loadJsonTests(named: "dd b3").prefix(testCycles))
        func test_OR_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR IXH (0xDDB4)",  arguments: loadJsonTests(named: "dd b4").prefix(testCycles))
        func test_OR_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR IXL (0xDDB5)",  arguments: loadJsonTests(named: "dd b5").prefix(testCycles))
        func test_OR_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR A (0xDDB7)",  arguments: loadJsonTests(named: "dd b7").prefix(testCycles))
        func test_OR_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP B (0xDDB8)",  arguments: loadJsonTests(named: "dd b8").prefix(testCycles))
        func test_CP_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP C (0xDDB9)",  arguments: loadJsonTests(named: "dd b9").prefix(testCycles))
        func test_CP_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP D (0xDDBA)",  arguments: loadJsonTests(named: "dd ba").prefix(testCycles))
        func test_CP_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP E (0xDDBB)",  arguments: loadJsonTests(named: "dd bb").prefix(testCycles))
        func test_CP_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP IXH (0xDDBC)",  arguments: loadJsonTests(named: "dd bc").prefix(testCycles))
        func test_CP_IXH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP IXL (0xDDBD)",  arguments: loadJsonTests(named: "dd bd").prefix(testCycles))
        func test_CP_IXL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP A (0xDDBF)",  arguments: loadJsonTests(named: "dd bf").prefix(testCycles))
        func test_CP_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
    ...
    struct UndocumentExtendedOpcodesDDCB: testHelper
    {
        ...
        @Test("Validate RLC (IX+$d),B (0xDDCB __ 00)",  arguments: loadJsonTests(named: "dd cb __ 00").prefix(testCycles))
        func test_RLC_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IX+$d),C (0xDDCB __ 01)",  arguments: loadJsonTests(named: "dd cb __ 01").prefix(testCycles))
        func test_RLC_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IX+$d),D (0xDDCB __ 02)",  arguments: loadJsonTests(named: "dd cb __ 02").prefix(testCycles))
        func test_RLC_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IX+$d),E (0xDDCB __ 03)",  arguments: loadJsonTests(named: "dd cb __ 03").prefix(testCycles))
        func test_RLC_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IX+$d),H (0xDDCB __ 04)",  arguments: loadJsonTests(named: "dd cb __ 04").prefix(testCycles))
        func test_RLC_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IX+$d),L (0xDDCB __ 05)",  arguments: loadJsonTests(named: "dd cb __ 05").prefix(testCycles))
        func test_RLC_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IX+$d),A (0xDDCB __ 07)",  arguments: loadJsonTests(named: "dd cb __ 07").prefix(testCycles))
        func test_RLC_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),B (0xDDCB __ 08)",  arguments: loadJsonTests(named: "dd cb __ 08").prefix(testCycles))
        func test_RRC_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),C (0xDDCB __ 09)",  arguments: loadJsonTests(named: "dd cb __ 09").prefix(testCycles))
        func test_RRC_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),D (0xDDCB __ 0A)",  arguments: loadJsonTests(named: "dd cb __ 0a").prefix(testCycles))
        func test_RRC_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),E (0xDDCB __ 0B)",  arguments: loadJsonTests(named: "dd cb __ 0b").prefix(testCycles))
        func test_RRC_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),H (0xDDCB __ 0C)",  arguments: loadJsonTests(named: "dd cb __ 0c").prefix(testCycles))
        func test_RRC_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),L (0xDDCB __ 0D)",  arguments: loadJsonTests(named: "dd cb __ 0d").prefix(testCycles))
        func test_RRC_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IX+$d),A (0xDDCB __ 0F)",  arguments: loadJsonTests(named: "dd cb __ 0f").prefix(testCycles))
        func test_RRC_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),B (0xDDCB __ 10)",  arguments: loadJsonTests(named: "dd cb __ 10").prefix(testCycles))
        func test_RL_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),C (0xDDCB __ 11)",  arguments: loadJsonTests(named: "dd cb __ 11").prefix(testCycles))
        func test_RL_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),D (0xDDCB __ 12)",  arguments: loadJsonTests(named: "dd cb __ 12").prefix(testCycles))
        func test_RL_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),E (0xDDCB __ 13)",  arguments: loadJsonTests(named: "dd cb __ 13").prefix(testCycles))
        func test_RL_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),H (0xDDCB __ 14)",  arguments: loadJsonTests(named: "dd cb __ 14").prefix(testCycles))
        func test_RL_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),L (0xDDCB __ 15)",  arguments: loadJsonTests(named: "dd cb __ 15").prefix(testCycles))
        func test_RL_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IX+$d),A (0xDDCB __ 17)",  arguments: loadJsonTests(named: "dd cb __ 17").prefix(testCycles))
        func test_RL_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),B (0xDDCB __ 18)",  arguments: loadJsonTests(named: "dd cb __ 18").prefix(testCycles))
        func test_RR_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),C (0xDDCB __ 19)",  arguments: loadJsonTests(named: "dd cb __ 19").prefix(testCycles))
        func test_RR_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),D (0xDDCB __ 1A)",  arguments: loadJsonTests(named: "dd cb __ 1a").prefix(testCycles))
        func test_RR_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),E (0xDDCB __ 1B)",  arguments: loadJsonTests(named: "dd cb __ 1b").prefix(testCycles))
        func test_RR_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),H (0xDDCB __ 1C)",  arguments: loadJsonTests(named: "dd cb __ 1c").prefix(testCycles))
        func test_RR_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),L (0xDDCB __ 1D)",  arguments: loadJsonTests(named: "dd cb __ 1d").prefix(testCycles))
        func test_RR_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IX+$d),A (0xDDCB __ 1F)",  arguments: loadJsonTests(named: "dd cb __ 1f").prefix(testCycles))
        func test_RR_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),B (0xDDCB __ 20)",  arguments: loadJsonTests(named: "dd cb __ 20").prefix(testCycles))
        func test_SLA_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),C (0xDDCB __ 21)",  arguments: loadJsonTests(named: "dd cb __ 21").prefix(testCycles))
        func test_SLA_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),D (0xDDCB __ 22)",  arguments: loadJsonTests(named: "dd cb __ 22").prefix(testCycles))
        func test_SLA_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),E (0xDDCB __ 23)",  arguments: loadJsonTests(named: "dd cb __ 23").prefix(testCycles))
        func test_SLA_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),H (0xDDCB __ 24)",  arguments: loadJsonTests(named: "dd cb __ 24").prefix(testCycles))
        func test_SLA_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),L (0xDDCB __ 25)",  arguments: loadJsonTests(named: "dd cb __ 25").prefix(testCycles))
        func test_SLA_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IX+$d),A (0xDDCB __ 27)",  arguments: loadJsonTests(named: "dd cb __ 27").prefix(testCycles))
        func test_SLA_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),B (0xDDCB __ 28)",  arguments: loadJsonTests(named: "dd cb __ 28").prefix(testCycles))
        func test_SRA_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),C (0xDDCB __ 29)",  arguments: loadJsonTests(named: "dd cb __ 29").prefix(testCycles))
        func test_SRA_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),D (0xDDCB __ 2A)",  arguments: loadJsonTests(named: "dd cb __ 2a").prefix(testCycles))
        func test_SRA_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),E (0xDDCB __ 2B)",  arguments: loadJsonTests(named: "dd cb __ 2b").prefix(testCycles))
        func test_SRA_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),H (0xDDCB __ 2C)",  arguments: loadJsonTests(named: "dd cb __ 2c").prefix(testCycles))
        func test_SRA_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),L (0xDDCB __ 2D)",  arguments: loadJsonTests(named: "dd cb __ 2d").prefix(testCycles))
        func test_SRA_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IX+$d),A (0xDDCB __ 2F)",  arguments: loadJsonTests(named: "dd cb __ 2f").prefix(testCycles))
        func test_SRA_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),B (0xDDCB __ 30)",  arguments: loadJsonTests(named: "dd cb __ 30").prefix(testCycles))
        func test_SLL_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),C (0xDDCB __ 31)",  arguments: loadJsonTests(named: "dd cb __ 31").prefix(testCycles))
        func test_SLL_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),D (0xDDCB __ 32)",  arguments: loadJsonTests(named: "dd cb __ 32").prefix(testCycles))
        func test_SLL_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),E (0xDDCB __ 33)",  arguments: loadJsonTests(named: "dd cb __ 33").prefix(testCycles))
        func test_SLL_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),H (0xDDCB __ 34)",  arguments: loadJsonTests(named: "dd cb __ 34").prefix(testCycles))
        func test_SLL_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),L (0xDDCB __ 35)",  arguments: loadJsonTests(named: "dd cb __ 35").prefix(testCycles))
        func test_SLL_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d) (0xDDCB __ 36)",  arguments: loadJsonTests(named: "dd cb __ 36").prefix(testCycles))
        func test_SLL_CON_IX_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IX+$d),A (0xDDCB __ 37)",  arguments: loadJsonTests(named: "dd cb __ 37").prefix(testCycles))
        func test_SLL_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),B (0xDDCB __ 38)",  arguments: loadJsonTests(named: "dd cb __ 38").prefix(testCycles))
        func test_SRL_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),C (0xDDCB __ 39)",  arguments: loadJsonTests(named: "dd cb __ 39").prefix(testCycles))
        func test_SRL_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),D (0xDDCB __ 3A)",  arguments: loadJsonTests(named: "dd cb __ 3a").prefix(testCycles))
        func test_SRL_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),E (0xDDCB __ 3B)",  arguments: loadJsonTests(named: "dd cb __ 3b").prefix(testCycles))
        func test_SRL_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),H (0xDDCB __ 3C)",  arguments: loadJsonTests(named: "dd cb __ 3c").prefix(testCycles))
        func test_SRL_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),L (0xDDCB __ 3D)",  arguments: loadJsonTests(named: "dd cb __ 3d").prefix(testCycles))
        func test_SRL_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IX+$d),A (0xDDCB __ 3F)",  arguments: loadJsonTests(named: "dd cb __ 3f").prefix(testCycles))
        func test_SRL_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 40)",  arguments: loadJsonTests(named: "dd cb __ 40").prefix(testCycles))
        func test_BIT_0_CON_IX_D_40(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 41)",  arguments: loadJsonTests(named: "dd cb __ 41").prefix(testCycles))
        func test_BIT_0_CON_IX_D_41(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 42)",  arguments: loadJsonTests(named: "dd cb __ 42").prefix(testCycles))
        func test_BIT_0_CON_IX_D_42(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 43)",  arguments: loadJsonTests(named: "dd cb __ 43").prefix(testCycles))
        func test_BIT_0_CON_IX_D_43(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 44)",  arguments: loadJsonTests(named: "dd cb __ 44").prefix(testCycles))
        func test_BIT_0_CON_IX_D_44(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 45)",  arguments: loadJsonTests(named: "dd cb __ 45").prefix(testCycles))
        func test_BIT_0_CON_IX_D_45(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IX+$d) (0xDDCB __ 47)",  arguments: loadJsonTests(named: "dd cb __ 47").prefix(testCycles))
        func test_BIT_0_CON_IX_D_47(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 48)",  arguments: loadJsonTests(named: "dd cb __ 48").prefix(testCycles))
        func test_BIT_1_CON_IX_D_48(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 49)",  arguments: loadJsonTests(named: "dd cb __ 49").prefix(testCycles))
        func test_BIT_1_CON_IX_D_49(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 4A)",  arguments: loadJsonTests(named: "dd cb __ 4a").prefix(testCycles))
        func test_BIT_1_CON_IX_D_4A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 4B)",  arguments: loadJsonTests(named: "dd cb __ 4b").prefix(testCycles))
        func test_BIT_1_CON_IX_D_4B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 4C)",  arguments: loadJsonTests(named: "dd cb __ 4c").prefix(testCycles))
        func test_BIT_1_CON_IX_D_4C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 4D)",  arguments: loadJsonTests(named: "dd cb __ 4d").prefix(testCycles))
        func test_BIT_1_CON_IX_D_4D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IX+$d) (0xDDCB __ 4F)",  arguments: loadJsonTests(named: "dd cb __ 4f").prefix(testCycles))
        func test_BIT_1_CON_IX_D_4F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 50)",  arguments: loadJsonTests(named: "dd cb __ 50").prefix(testCycles))
        func test_BIT_2_CON_IX_D_50(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 51)",  arguments: loadJsonTests(named: "dd cb __ 51").prefix(testCycles))
        func test_BIT_2_CON_IX_D_51(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 52)",  arguments: loadJsonTests(named: "dd cb __ 52").prefix(testCycles))
        func test_BIT_2_CON_IX_D_52(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 53)",  arguments: loadJsonTests(named: "dd cb __ 53").prefix(testCycles))
        func test_BIT_2_CON_IX_D_53(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 54)",  arguments: loadJsonTests(named: "dd cb __ 54").prefix(testCycles))
        func test_BIT_2_CON_IX_D_54(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 55)",  arguments: loadJsonTests(named: "dd cb __ 55").prefix(testCycles))
        func test_BIT_2_CON_IX_D_55(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IX+$d) (0xDDCB __ 57)",  arguments: loadJsonTests(named: "dd cb __ 57").prefix(testCycles))
        func test_BIT_2_CON_IX_D_57(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 58)",  arguments: loadJsonTests(named: "dd cb __ 58").prefix(testCycles))
        func test_BIT_3_CON_IX_D_58(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 59)",  arguments: loadJsonTests(named: "dd cb __ 59").prefix(testCycles))
        func test_BIT_3_CON_IX_D_59(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 5A)",  arguments: loadJsonTests(named: "dd cb __ 5a").prefix(testCycles))
        func test_BIT_3_CON_IX_D_5A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 5B)",  arguments: loadJsonTests(named: "dd cb __ 5b").prefix(testCycles))
        func test_BIT_3_CON_IX_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 5C)",  arguments: loadJsonTests(named: "dd cb __ 5c").prefix(testCycles))
        func test_BIT_3_CON_IX_D_5C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 5D)",  arguments: loadJsonTests(named: "dd cb __ 5d").prefix(testCycles))
        func test_BIT_3_CON_IX_D_5D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IX+$d) (0xDDCB __ 5F)",  arguments: loadJsonTests(named: "dd cb __ 5f").prefix(testCycles))
        func test_BIT_3_CON_IX_D_5F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 60)",  arguments: loadJsonTests(named: "dd cb __ 60").prefix(testCycles))
        func test_BIT_4_CON_IX_D_60(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 61)",  arguments: loadJsonTests(named: "dd cb __ 61").prefix(testCycles))
        func test_BIT_4_CON_IX_D_61(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 62)",  arguments: loadJsonTests(named: "dd cb __ 62").prefix(testCycles))
        func test_BIT_4_CON_IX_D_62(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 63)",  arguments: loadJsonTests(named: "dd cb __ 63").prefix(testCycles))
        func test_BIT_4_CON_IX_D_63(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 64)",  arguments: loadJsonTests(named: "dd cb __ 64").prefix(testCycles))
        func test_BIT_4_CON_IX_D_64(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 65)",  arguments: loadJsonTests(named: "dd cb __ 65").prefix(testCycles))
        func test_BIT_4_CON_IX_D_65(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IX+$d) (0xDDCB __ 67)",  arguments: loadJsonTests(named: "dd cb __ 67").prefix(testCycles))
        func test_BIT_4_CON_IX_D_67(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 68)",  arguments: loadJsonTests(named: "dd cb __ 68").prefix(testCycles))
        func test_BIT_5_CON_IX_D_68(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 69)",  arguments: loadJsonTests(named: "dd cb __ 69").prefix(testCycles))
        func test_BIT_5_CON_IX_D_69(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 6A)",  arguments: loadJsonTests(named: "dd cb __ 6a").prefix(testCycles))
        func test_BIT_5_CON_IX_D_6A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 6B)",  arguments: loadJsonTests(named: "dd cb __ 6b").prefix(testCycles))
        func test_BIT_5_CON_IX_D_6B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 6C)",  arguments: loadJsonTests(named: "dd cb __ 6c").prefix(testCycles))
        func test_BIT_5_CON_IX_D_6C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 6D)",  arguments: loadJsonTests(named: "dd cb __ 6d").prefix(testCycles))
        func test_BIT_5_CON_IX_D_6D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IX+$d) (0xDDCB __ 6F)",  arguments: loadJsonTests(named: "dd cb __ 6f").prefix(testCycles))
        func test_BIT_5_CON_IX_D_6F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 70)",  arguments: loadJsonTests(named: "dd cb __ 70").prefix(testCycles))
        func test_BIT_6_CON_IX_D_70(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 71)",  arguments: loadJsonTests(named: "dd cb __ 71").prefix(testCycles))
        func test_BIT_6_CON_IX_D_71(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 72)",  arguments: loadJsonTests(named: "dd cb __ 72").prefix(testCycles))
        func test_BIT_6_CON_IX_D_72(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 73)",  arguments: loadJsonTests(named: "dd cb __ 73").prefix(testCycles))
        func test_BIT_6_CON_IX_D_73(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 74)",  arguments: loadJsonTests(named: "dd cb __ 74").prefix(testCycles))
        func test_BIT_6_CON_IX_D_74(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 75)",  arguments: loadJsonTests(named: "dd cb __ 75").prefix(testCycles))
        func test_BIT_6_CON_IX_D_75(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IX+$d) (0xDDCB __ 77)",  arguments: loadJsonTests(named: "dd cb __ 77").prefix(testCycles))
        func test_BIT_6_CON_IX_D_77(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 78)",  arguments: loadJsonTests(named: "dd cb __ 78").prefix(testCycles))
        func test_BIT_7_CON_IX_D_78(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 79)",  arguments: loadJsonTests(named: "dd cb __ 79").prefix(testCycles))
        func test_BIT_7_CON_IX_D_79(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 7A)",  arguments: loadJsonTests(named: "dd cb __ 7a").prefix(testCycles))
        func test_BIT_7_CON_IX_D_7A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 7B)",  arguments: loadJsonTests(named: "dd cb __ 7b").prefix(testCycles))
        func test_BIT_7_CON_IX_D_7B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 7C)",  arguments: loadJsonTests(named: "dd cb __ 7c").prefix(testCycles))
        func test_BIT_7_CON_IX_D_7C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 7D)",  arguments: loadJsonTests(named: "dd cb __ 7d").prefix(testCycles))
        func test_BIT_7_CON_IX_D_7D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IX+$d) (0xDDCB __ 7F)",  arguments: loadJsonTests(named: "dd cb __ 7f").prefix(testCycles))
        func test_BIT_7_CON_IX_D_7F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),B (0xDDCB __ 80)",  arguments: loadJsonTests(named: "dd cb __ 80").prefix(testCycles))
        func test_RES_0_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),C (0xDDCB __ 81)",  arguments: loadJsonTests(named: "dd cb __ 81").prefix(testCycles))
        func test_RES_0_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),D (0xDDCB __ 82)",  arguments: loadJsonTests(named: "dd cb __ 82").prefix(testCycles))
        func test_RES_0_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),E (0xDDCB __ 83)",  arguments: loadJsonTests(named: "dd cb __ 83").prefix(testCycles))
        func test_RES_0_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),H (0xDDCB __ 84)",  arguments: loadJsonTests(named: "dd cb __ 84").prefix(testCycles))
        func test_RES_0_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),L (0xDDCB __ 85)",  arguments: loadJsonTests(named: "dd cb __ 85").prefix(testCycles))
        func test_RES_0_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IX+$d),A (0xDDCB __ 87)",  arguments: loadJsonTests(named: "dd cb __ 87").prefix(testCycles))
        func test_RES_0_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),B (0xDDCB __ 88)",  arguments: loadJsonTests(named: "dd cb __ 88").prefix(testCycles))
        func test_RES_1_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),C (0xDDCB __ 89)",  arguments: loadJsonTests(named: "dd cb __ 89").prefix(testCycles))
        func test_RES_1_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),D (0xDDCB __ 8A)",  arguments: loadJsonTests(named: "dd cb __ 8a").prefix(testCycles))
        func test_RES_1_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),E (0xDDCB __ 8B)",  arguments: loadJsonTests(named: "dd cb __ 8b").prefix(testCycles))
        func test_RES_1_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),H (0xDDCB __ 8C)",  arguments: loadJsonTests(named: "dd cb __ 8c").prefix(testCycles))
        func test_RES_1_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),L (0xDDCB __ 8D)",  arguments: loadJsonTests(named: "dd cb __ 8d").prefix(testCycles))
        func test_RES_1_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IX+$d),A (0xDDCB __ 8F)",  arguments: loadJsonTests(named: "dd cb __ 8f").prefix(testCycles))
        func test_RES_1_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),B (0xDDCB __ 90)",  arguments: loadJsonTests(named: "dd cb __ 90").prefix(testCycles))
        func test_RES_2_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),C (0xDDCB __ 91)",  arguments: loadJsonTests(named: "dd cb __ 91").prefix(testCycles))
        func test_RES_2_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),D (0xDDCB __ 92)",  arguments: loadJsonTests(named: "dd cb __ 92").prefix(testCycles))
        func test_RES_2_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),E (0xDDCB __ 93)",  arguments: loadJsonTests(named: "dd cb __ 93").prefix(testCycles))
        func test_RES_2_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),H (0xDDCB __ 94)",  arguments: loadJsonTests(named: "dd cb __ 94").prefix(testCycles))
        func test_RES_2_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),L (0xDDCB __ 95)",  arguments: loadJsonTests(named: "dd cb __ 95").prefix(testCycles))
        func test_RES_2_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IX+$d),A (0xDDCB __ 97)",  arguments: loadJsonTests(named: "dd cb __ 97").prefix(testCycles))
        func test_RES_2_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),B (0xDDCB __ 98)",  arguments: loadJsonTests(named: "dd cb __ 98").prefix(testCycles))
        func test_RES_3_CON_IX_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),C (0xDDCB __ 99)",  arguments: loadJsonTests(named: "dd cb __ 99").prefix(testCycles))
        func test_RES_3_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),D (0xDDCB __ 9A)",  arguments: loadJsonTests(named: "dd cb __ 9a").prefix(testCycles))
        func test_RES_3_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),E (0xDDCB __ 9B)",  arguments: loadJsonTests(named: "dd cb __ 9b").prefix(testCycles))
        func test_RES_3_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),H (0xDDCB __ 9C)",  arguments: loadJsonTests(named: "dd cb __ 9c").prefix(testCycles))
        func test_RES_3_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),L (0xDDCB __ 9D)",  arguments: loadJsonTests(named: "dd cb __ 9d").prefix(testCycles))
        func test_RES_3_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IX+$d),A (0xDDCB __ 9F)",  arguments: loadJsonTests(named: "dd cb __ 9f").prefix(testCycles))
        func test_RES_3_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),B (0xDDCB __ A0)",  arguments: loadJsonTests(named: "dd cb __ a0").prefix(testCycles))
        func test_RES_4_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),C (0xDDCB __ A1)",  arguments: loadJsonTests(named: "dd cb __ a1").prefix(testCycles))
        func test_RES_4_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),D (0xDDCB __ A2)",  arguments: loadJsonTests(named: "dd cb __ a2").prefix(testCycles))
        func test_RES_4_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),E (0xDDCB __ A3)",  arguments: loadJsonTests(named: "dd cb __ a3").prefix(testCycles))
        func test_RES_4_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),H (0xDDCB __ A4)",  arguments: loadJsonTests(named: "dd cb __ a4").prefix(testCycles))
        func test_RES_4_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),L (0xDDCB __ A5)",  arguments: loadJsonTests(named: "dd cb __ a5").prefix(testCycles))
        func test_RES_4_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IX+$d),A (0xDDCB __ A7)",  arguments: loadJsonTests(named: "dd cb __ a7").prefix(testCycles))
        func test_RES_4_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),B (0xDDCB __ A8)",  arguments: loadJsonTests(named: "dd cb __ a8").prefix(testCycles))
        func test_RES_5_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),C (0xDDCB __ A9)",  arguments: loadJsonTests(named: "dd cb __ a9").prefix(testCycles))
        func test_RES_5_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),D (0xDDCB __ AA)",  arguments: loadJsonTests(named: "dd cb __ aa").prefix(testCycles))
        func test_RES_5_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),E (0xDDCB __ AB)",  arguments: loadJsonTests(named: "dd cb __ ab").prefix(testCycles))
        func test_RES_5_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),H (0xDDCB __ AC)",  arguments: loadJsonTests(named: "dd cb __ ac").prefix(testCycles))
        func test_RES_5_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),L (0xDDCB __ AD)",  arguments: loadJsonTests(named: "dd cb __ ad").prefix(testCycles))
        func test_RES_5_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IX+$d),A (0xDDCB __ AF)",  arguments: loadJsonTests(named: "dd cb __ af").prefix(testCycles))
        func test_RES_5_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),B (0xDDCB __ B0)",  arguments: loadJsonTests(named: "dd cb __ b0").prefix(testCycles))
        func test_RES_6_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),C (0xDDCB __ B1)",  arguments: loadJsonTests(named: "dd cb __ b1").prefix(testCycles))
        func test_RES_6_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),D (0xDDCB __ B2)",  arguments: loadJsonTests(named: "dd cb __ b2").prefix(testCycles))
        func test_RES_6_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),E (0xDDCB __ B3)",  arguments: loadJsonTests(named: "dd cb __ b3").prefix(testCycles))
        func test_RES_6_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),H (0xDDCB __ B4)",  arguments: loadJsonTests(named: "dd cb __ b4").prefix(testCycles))
        func test_RES_6_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),L (0xDDCB __ B5)",  arguments: loadJsonTests(named: "dd cb __ b5").prefix(testCycles))
        func test_RES_6_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IX+$d),A (0xDDCB __ B7)",  arguments: loadJsonTests(named: "dd cb __ b7").prefix(testCycles))
        func test_RES_6_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),B (0xDDCB __ B8)",  arguments: loadJsonTests(named: "dd cb __ b8").prefix(testCycles))
        func test_RES_7_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),C (0xDDCB __ B9)",  arguments: loadJsonTests(named: "dd cb __ b9").prefix(testCycles))
        func test_RES_7_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),D (0xDDCB __ BA)",  arguments: loadJsonTests(named: "dd cb __ ba").prefix(testCycles))
        func test_RES_7_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),E (0xDDCB __ BB)",  arguments: loadJsonTests(named: "dd cb __ bb").prefix(testCycles))
        func test_RES_7_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),H (0xDDCB __ BC)",  arguments: loadJsonTests(named: "dd cb __ bc").prefix(testCycles))
        func test_RES_7_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),L (0xDDCB __ BD)",  arguments: loadJsonTests(named: "dd cb __ bd").prefix(testCycles))
        func test_RES_7_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IX+$d),A (0xDDCB __ BF)",  arguments: loadJsonTests(named: "dd cb __ bf").prefix(testCycles))
        func test_RES_7_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),B (0xDDCB __ C0)",  arguments: loadJsonTests(named: "dd cb __ c0").prefix(testCycles))
        func test_SET_0_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),C (0xDDCB __ C1)",  arguments: loadJsonTests(named: "dd cb __ c1").prefix(testCycles))
        func test_SET_0_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),D (0xDDCB __ C2)",  arguments: loadJsonTests(named: "dd cb __ c2").prefix(testCycles))
        func test_SET_0_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),E (0xDDCB __ C3)",  arguments: loadJsonTests(named: "dd cb __ c3").prefix(testCycles))
        func test_SET_0_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),H (0xDDCB __ C4)",  arguments: loadJsonTests(named: "dd cb __ c4").prefix(testCycles))
        func test_SET_0_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),L (0xDDCB __ C5)",  arguments: loadJsonTests(named: "dd cb __ c5").prefix(testCycles))
        func test_SET_0_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IX+$d),A (0xDDCB __ C7)",  arguments: loadJsonTests(named: "dd cb __ c7").prefix(testCycles))
        func test_SET_0_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),B (0xDDCB __ C8)",  arguments: loadJsonTests(named: "dd cb __ c8").prefix(testCycles))
        func test_SET_1_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),C (0xDDCB __ C9)",  arguments: loadJsonTests(named: "dd cb __ c9").prefix(testCycles))
        func test_SET_1_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),D (0xDDCB __ CA)",  arguments: loadJsonTests(named: "dd cb __ ca").prefix(testCycles))
        func test_SET_1_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),E (0xDDCB __ CB)",  arguments: loadJsonTests(named: "dd cb __ cb").prefix(testCycles))
        func test_SET_1_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),H (0xDDCB __ CC)",  arguments: loadJsonTests(named: "dd cb __ cc").prefix(testCycles))
        func test_SET_1_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),L (0xDDCB __ CD)",  arguments: loadJsonTests(named: "dd cb __ cd").prefix(testCycles))
        func test_SET_1_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IX+$d),A (0xDDCB __ CF)",  arguments: loadJsonTests(named: "dd cb __ cf").prefix(testCycles))
        func test_SET_1_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),B (0xDDCB __ D0)",  arguments: loadJsonTests(named: "dd cb __ d0").prefix(testCycles))
        func test_SET_2_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),C (0xDDCB __ D1)",  arguments: loadJsonTests(named: "dd cb __ d1").prefix(testCycles))
        func test_SET_2_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),D (0xDDCB __ D2)",  arguments: loadJsonTests(named: "dd cb __ d2").prefix(testCycles))
        func test_SET_2_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),E (0xDDCB __ D3)",  arguments: loadJsonTests(named: "dd cb __ d3").prefix(testCycles))
        func test_SET_2_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),H (0xDDCB __ D4)",  arguments: loadJsonTests(named: "dd cb __ d4").prefix(testCycles))
        func test_SET_2_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),L (0xDDCB __ D5)",  arguments: loadJsonTests(named: "dd cb __ d5").prefix(testCycles))
        func test_SET_2_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IX+$d),A (0xDDCB __ D7)",  arguments: loadJsonTests(named: "dd cb __ d7").prefix(testCycles))
        func test_SET_2_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),B (0xDDCB __ D8)",  arguments: loadJsonTests(named: "dd cb __ d8").prefix(testCycles))
        func test_SET_3_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),C (0xDDCB __ D9)",  arguments: loadJsonTests(named: "dd cb __ d9").prefix(testCycles))
        func test_SET_3_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),D (0xDDCB __ DA)",  arguments: loadJsonTests(named: "dd cb __ da").prefix(testCycles))
        func test_SET_3_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),E (0xDDCB __ DB)",  arguments: loadJsonTests(named: "dd cb __ db").prefix(testCycles))
        func test_SET_3_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),H (0xDDCB __ DC)",  arguments: loadJsonTests(named: "dd cb __ dc").prefix(testCycles))
        func test_SET_3_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),L (0xDDCB __ DD)",  arguments: loadJsonTests(named: "dd cb __ dd").prefix(testCycles))
        func test_SET_3_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IX+$d),A (0xDDCB __ DF)",  arguments: loadJsonTests(named: "dd cb __ df").prefix(testCycles))
        func test_SET_3_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),B (0xDDCB __ E0)",  arguments: loadJsonTests(named: "dd cb __ e0").prefix(testCycles))
        func test_SET_4_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),C (0xDDCB __ E1)",  arguments: loadJsonTests(named: "dd cb __ e1").prefix(testCycles))
        func test_SET_4_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),D (0xDDCB __ E2)",  arguments: loadJsonTests(named: "dd cb __ e2").prefix(testCycles))
        func test_SET_4_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),E (0xDDCB __ E3)",  arguments: loadJsonTests(named: "dd cb __ e3").prefix(testCycles))
        func test_SET_4_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),H (0xDDCB __ E4)",  arguments: loadJsonTests(named: "dd cb __ e4").prefix(testCycles))
        func test_SET_4_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),L (0xDDCB __ E5)",  arguments: loadJsonTests(named: "dd cb __ e5").prefix(testCycles))
        func test_SET_4_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IX+$d),A (0xDDCB __ E7)",  arguments: loadJsonTests(named: "dd cb __ e7").prefix(testCycles))
        func test_SET_4_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),B (0xDDCB __ E8)",  arguments: loadJsonTests(named: "dd cb __ e8").prefix(testCycles))
        func test_SET_5_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),C (0xDDCB __ E9)",  arguments: loadJsonTests(named: "dd cb __ e9").prefix(testCycles))
        func test_SET_5_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),D (0xDDCB __ EA)",  arguments: loadJsonTests(named: "dd cb __ ea").prefix(testCycles))
        func test_SET_5_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),E (0xDDCB __ EB)",  arguments: loadJsonTests(named: "dd cb __ eb").prefix(testCycles))
        func test_SET_5_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),H (0xDDCB __ EC)",  arguments: loadJsonTests(named: "dd cb __ ec").prefix(testCycles))
        func test_SET_5_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),L (0xDDCB __ ED)",  arguments: loadJsonTests(named: "dd cb __ ed").prefix(testCycles))
        func test_SET_5_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IX+$d),A (0xDDCB __ EF)",  arguments: loadJsonTests(named: "dd cb __ ef").prefix(testCycles))
        func test_SET_5_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),B (0xDDCB __ F0)",  arguments: loadJsonTests(named: "dd cb __ f0").prefix(testCycles))
        func test_SET_6_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),C (0xDDCB __ F1)",  arguments: loadJsonTests(named: "dd cb __ f1").prefix(testCycles))
        func test_SET_6_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),D (0xDDCB __ F2)",  arguments: loadJsonTests(named: "dd cb __ f2").prefix(testCycles))
        func test_SET_6_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),E (0xDDCB __ F3)",  arguments: loadJsonTests(named: "dd cb __ f3").prefix(testCycles))
        func test_SET_6_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),H (0xDDCB __ F4)",  arguments: loadJsonTests(named: "dd cb __ f4").prefix(testCycles))
        func test_SET_6_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),L (0xDDCB __ F5)",  arguments: loadJsonTests(named: "dd cb __ f5").prefix(testCycles))
        func test_SET_6_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IX+$d),A (0xDDCB __ F7)",  arguments: loadJsonTests(named: "dd cb __ f7").prefix(testCycles))
        func test_SET_6_CON_IX_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),B (0xDDCB __ F8)",  arguments: loadJsonTests(named: "dd cb __ f8").prefix(testCycles))
        func test_SET_7_CON_IX_D_B (testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),C (0xDDCB __ F9)",  arguments: loadJsonTests(named: "dd cb __ f9").prefix(testCycles))
        func test_SET_7_CON_IX_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),D (0xDDCB __ FA)",  arguments: loadJsonTests(named: "dd cb __ fa").prefix(testCycles))
        func test_SET_7_CON_IX_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),E (0xDDCB __ FB)",  arguments: loadJsonTests(named: "dd cb __ fb").prefix(testCycles))
        func test_SET_7_CON_IX_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),H (0xDDCB __ FC)",  arguments: loadJsonTests(named: "dd cb __ fc").prefix(testCycles))
        func test_SET_7_CON_IX_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),L (0xDDCB __ FD)",  arguments: loadJsonTests(named: "dd cb __ fd").prefix(testCycles))
        func test_SET_7_CON_IX_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IX+$d),A (0xDDCB __ FF)",  arguments: loadJsonTests(named: "dd cb __ ff").prefix(testCycles))
    ...
    struct UndocumentExtendedOpcodesED: testHelper
    {
        ...
        @Test("Validate LD ($nn),HL (0xED63)",  arguments: loadJsonTests(named: "ed 63").prefix(testCycles))
        func test_LD_CON_NN_HL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD HL,($nn) (0xED6B)",  arguments: loadJsonTests(named: "ed 6B").prefix(testCycles))
        func test_LD_HL_CON_NN(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate IN (C) (0xED70)",  arguments: loadJsonTests(named: "ed 70").prefix(testCycles))
        func test_IN_CON_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OUT (C),0 (0xED71)",  arguments: loadJsonTests(named: "ed 71").prefix(testCycles))
    ...
    struct UndocumentExtendedOpcodesFD: testHelper
    {
        ...
        @Test("Validate INC B (0xFD04)",  arguments: loadJsonTests(named: "fd 04").prefix(testCycles))
        func test_INC_B_FD04(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC B (0xFD05)",  arguments: loadJsonTests(named: "fd 05").prefix(testCycles))
        func test_DEC_B_FD05(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,$n (0xFD06)",  arguments: loadJsonTests(named: "fd 06").prefix(testCycles))
        func test_LD_B_N_FD06(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC C (0xFD0C)",  arguments: loadJsonTests(named: "fd 0c").prefix(testCycles))
        func test_INC_C_FD0C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC C (0xFD0D)",  arguments: loadJsonTests(named: "fd 0d").prefix(testCycles))
        func test_DEC_C_FD0D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,$n (0xFD0E)",  arguments: loadJsonTests(named: "fd 0e").prefix(testCycles))
        func test_LD_C_N_FD0E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC D (0xFD14)",  arguments: loadJsonTests(named: "fd 14").prefix(testCycles))
        func test_INC_D_FD14(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC D (0xFD15)",  arguments: loadJsonTests(named: "fd 15").prefix(testCycles))
        func test_DEC_D_FD15(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,$n (0xFD16)",  arguments: loadJsonTests(named: "fd 16").prefix(testCycles))
        func test_LD_D_N_FD16(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC E (0xFD1C)",  arguments: loadJsonTests(named: "fd 1c").prefix(testCycles))
        func test_INC_E_FD1C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC E (0xFD1D)",  arguments: loadJsonTests(named: "fd 1d").prefix(testCycles))
        func test_DEC_E_FD1D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,$n (0xFD1E)",  arguments: loadJsonTests(named: "fd 1e").prefix(testCycles))
        func test_LD_E_N_FD1E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC IYH (0xFD24)",  arguments: loadJsonTests(named: "fd 24").prefix(testCycles))
        func test_INC_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC IYH (0xFD25)",  arguments: loadJsonTests(named: "fd 25").prefix(testCycles))
        func test_DEC_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,$n (0xFD26)",  arguments: loadJsonTests(named: "fd 26").prefix(testCycles))
        func test_LD_IYH_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC IYL (0xFD2C)",  arguments: loadJsonTests(named: "fd 2c").prefix(testCycles))
        func test_INC_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC IYL (0xFD2D)",  arguments: loadJsonTests(named: "fd 2d").prefix(testCycles))
        func test_DEC_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,$n (0xFD2E)",  arguments: loadJsonTests(named: "fd 2e").prefix(testCycles))
        func test_LD_IYL_N(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate INC A (0xFD3C)",  arguments: loadJsonTests(named: "fd 3c").prefix(testCycles))
        func test_INC_A_FD3XC(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate DEC A (0xFD3D)",  arguments: loadJsonTests(named: "fd 3d").prefix(testCycles))
        func test_DEC_A_FD3D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,$n (0xFD3E)",  arguments: loadJsonTests(named: "fd 3e").prefix(testCycles))
        func test_LD_A_N_FD3E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,B (0xFD40)",  arguments: loadJsonTests(named: "fd 40").prefix(testCycles))
        func test_LD_B_B_FD40(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,C (0xFD41)",  arguments: loadJsonTests(named: "fd 41").prefix(testCycles))
        func test_LD_B_C_FD41(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,D (0xFD42)",  arguments: loadJsonTests(named: "fd 42").prefix(testCycles))
        func test_LD_B_D_FD42(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,E (0xFD43)",  arguments: loadJsonTests(named: "fd 43").prefix(testCycles))
        func test_LD_B_E_FD43(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,IYH (0xFD44)",  arguments: loadJsonTests(named: "fd 44").prefix(testCycles))
        func test_LD_B_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,IYL (0xFD45)",  arguments: loadJsonTests(named: "fd 45").prefix(testCycles))
        func test_LD_B_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD B,A (0xFD47)",  arguments: loadJsonTests(named: "fd 47").prefix(testCycles))
        func test_LD_B_A_FD47(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,B (0xFD48)",  arguments: loadJsonTests(named: "fd 48").prefix(testCycles))
        func test_LD_C_B_FD48(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,C (0xFD49)",  arguments: loadJsonTests(named: "fd 49").prefix(testCycles))
        func test_LD_C_C_FD49(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,D (0xFD4A)",  arguments: loadJsonTests(named: "fd 4a").prefix(testCycles))
        func test_LD_C_D_FD4A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,E (0xFD4B)",  arguments: loadJsonTests(named: "fd 4b").prefix(testCycles))
        func test_LD_C_E_FD4B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,IYH (0xFD4C)",  arguments: loadJsonTests(named: "fd 4c").prefix(testCycles))
        func test_LD_C_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,IYL (0xFD4D)",  arguments: loadJsonTests(named: "fd 4d").prefix(testCycles))
        func test_LD_C_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD C,A (0xFD4F)",  arguments: loadJsonTests(named: "fd 4f").prefix(testCycles))
        func test_LD_C_A_FD4F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,B (0xFD50)",  arguments: loadJsonTests(named: "fd 50").prefix(testCycles))
        func test_LD_D_B_FD50(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,C (0xFD51)",  arguments: loadJsonTests(named: "fd 51").prefix(testCycles))
        func test_LD_D_C_FD51(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,D (0xFD52)",  arguments: loadJsonTests(named: "fd 52").prefix(testCycles))
        func test_LD_D_D_FD52(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,E (0xFD53)",  arguments: loadJsonTests(named: "fd 53").prefix(testCycles))
        func test_LD_D_E_FD53(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,IYH (0xFD54)",  arguments: loadJsonTests(named: "fd 54").prefix(testCycles))
        func test_LD_D_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,IYL (0xFD55)",  arguments: loadJsonTests(named: "fd 55").prefix(testCycles))
        func test_LD_D_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD D,A (0xFD57)",  arguments: loadJsonTests(named: "fd 57").prefix(testCycles))
        func test_LD_D_A_FD57(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,B (0xFD58)",  arguments: loadJsonTests(named: "fd 58").prefix(testCycles))
        func test_LD_E_B_FD58(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,C (0xFD59)",  arguments: loadJsonTests(named: "fd 59").prefix(testCycles))
        func test_LD_E_C_FD59(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,D (0xFD5A)",  arguments: loadJsonTests(named: "fd 5a").prefix(testCycles))
        func test_LD_E_D_FD5A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,E (0xFD5B)",  arguments: loadJsonTests(named: "fd 5b").prefix(testCycles))
        func test_LD_E_E_FD5B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,IYH (0xFD5C)",  arguments: loadJsonTests(named: "fd 5c").prefix(testCycles))
        func test_LD_E_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,IYL (0xFD5D)",  arguments: loadJsonTests(named: "fd 5d").prefix(testCycles))
        func test_LD_E_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD E,A (0xFD5F)",  arguments: loadJsonTests(named: "fd 5f").prefix(testCycles))
        func test_LD_E_A_FD5F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,B (0xFD60)",  arguments: loadJsonTests(named: "fd 60").prefix(testCycles))
        func test_LD_IYH_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,C (0xFD61)",  arguments: loadJsonTests(named: "fd 61").prefix(testCycles))
        func test_LD_IYH_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,D (0xFD62)",  arguments: loadJsonTests(named: "fd 62").prefix(testCycles))
        func test_LD_IYH_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,E (0xFD63)",  arguments: loadJsonTests(named: "fd 63").prefix(testCycles))
        func test_LD_IYH_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,IYH (0xFD64)",  arguments: loadJsonTests(named: "fd 64").prefix(testCycles))
        func test_LD_IYH_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,IYL (0xFD65)",  arguments: loadJsonTests(named: "fd 65").prefix(testCycles))
        func test_LD_IYH_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYH,A (0xFD67)",  arguments: loadJsonTests(named: "fd 67").prefix(testCycles))
        func test_LD_IYH_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,B (0xFD68)",  arguments: loadJsonTests(named: "fd 68").prefix(testCycles))
        func test_LD_IYL_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,C (0xFD69)",  arguments: loadJsonTests(named: "fd 69").prefix(testCycles))
        func test_LD_IYL_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,D (0xFD6A)",  arguments: loadJsonTests(named: "fd 6a").prefix(testCycles))
        func test_LD_IYL_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,E (0xFD6B)",  arguments: loadJsonTests(named: "fd 6b").prefix(testCycles))
        func test_LD_IYL_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,IYH (0xFD6C)",  arguments: loadJsonTests(named: "fd 6c").prefix(testCycles))
        func test_LD_IYL_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,IYL (0xFD6D)",  arguments: loadJsonTests(named: "fd 6d").prefix(testCycles))
        func test_LD_IYL_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD IYL,A (0xFD6F)",  arguments: loadJsonTests(named: "fd 6f").prefix(testCycles))
        func test_LD_IYL_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,B (0xFD78)",  arguments: loadJsonTests(named: "fd 78").prefix(testCycles))
        func test_LD_A_B_FD78(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,C (0xFD79)",  arguments: loadJsonTests(named: "fd 79").prefix(testCycles))
        func test_LD_A_C_FD79(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,D (0xFD7A)",  arguments: loadJsonTests(named: "fd 7a").prefix(testCycles))
        func test_LD_A_D_FD7A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,E (0xFD7B)",  arguments: loadJsonTests(named: "fd 7b").prefix(testCycles))
        func test_LD_A_E_FD7B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,IYH (0xFD7C)",  arguments: loadJsonTests(named: "fd 7c").prefix(testCycles))
        func test_LD_A_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,IYL (0xFD7D)",  arguments: loadJsonTests(named: "fd 7d").prefix(testCycles))
        func test_LD_A_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate LD A,A (0xFD7F)",  arguments: loadJsonTests(named: "fd 7f").prefix(testCycles))
        func test_LD_A_A_FD7F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,B (0xFD80)",  arguments: loadJsonTests(named: "fd 80").prefix(testCycles))
        func test_ADD_A_B_FD80(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,C (0xFD81)",  arguments: loadJsonTests(named: "fd 81").prefix(testCycles))
        func test_ADD_A_C_FD81(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,D (0xFD82)",  arguments: loadJsonTests(named: "fd 82").prefix(testCycles))
        func test_ADD_A_D_FD82(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,E (0xFD83)",  arguments: loadJsonTests(named: "fd 83").prefix(testCycles))
        func test_ADD_A_E_FD83(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,IYH (0xFD84)",  arguments: loadJsonTests(named: "fd 84").prefix(testCycles))
        func test_ADD_A_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,IYL (0xFD85)",  arguments: loadJsonTests(named: "fd 85").prefix(testCycles))
        func test_ADD_A_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADD A,A (0xFD87)",  arguments: loadJsonTests(named: "fd 87").prefix(testCycles))
        func test_ADD_A_A_FD87(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,B (0xFD88)",  arguments: loadJsonTests(named: "fd 88").prefix(testCycles))
        func test_ADC_A_B_FD88(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,C (0xFD89)",  arguments: loadJsonTests(named: "fd 89").prefix(testCycles))
        func test_ADC_A_C_FD89(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,D (0xFD8A)",  arguments: loadJsonTests(named: "fd 8a").prefix(testCycles))
        func test_ADC_A_D_FD8A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,E (0xFD8B)",  arguments: loadJsonTests(named: "fd 8b").prefix(testCycles))
        func test_ADC_A_E_FD8B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,IYH (0xFD8C)",  arguments: loadJsonTests(named: "fd 8c").prefix(testCycles))
        func test_ADC_A_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,IYL (0xFD8D)",  arguments: loadJsonTests(named: "fd 8d").prefix(testCycles))
        func test_ADC_A_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate ADC A,A (0xFD8F)",  arguments: loadJsonTests(named: "fd 8f").prefix(testCycles))
        func test_ADC_A_A_FD8F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB B (0xFD90)",  arguments: loadJsonTests(named: "fd 90").prefix(testCycles))
        func test_SUB_B_FD90(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB C (0xFD91)",  arguments: loadJsonTests(named: "fd 91").prefix(testCycles))
        func test_SUB_C_FD91(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB D (0xFD92)",  arguments: loadJsonTests(named: "fd 92").prefix(testCycles))
        func test_SUB_D_FD92(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB E (0xFD93)",  arguments: loadJsonTests(named: "fd 93").prefix(testCycles))
        func test_SUB_E_FD93(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB IYH (0xFD94)",  arguments: loadJsonTests(named: "fd 94").prefix(testCycles))
        func test_SUB_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB IYL (0xFD95)",  arguments: loadJsonTests(named: "fd 95").prefix(testCycles))
        func test_SUB_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SUB A (0xFD97)",  arguments: loadJsonTests(named: "fd 97").prefix(testCycles))
        func test_SUB_A_FD97(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,B (0xFD98)",  arguments: loadJsonTests(named: "fd 98").prefix(testCycles))
        func test_SBC_A_B_FD98(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,C (0xFD99)",  arguments: loadJsonTests(named: "fd 99").prefix(testCycles))
        func test_SBC_A_C_FD99(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,D (0xFD9A)",  arguments: loadJsonTests(named: "fd 9a").prefix(testCycles))
        func test_SBC_A_D_FD9A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,E (0xFD9B)",  arguments: loadJsonTests(named: "fd 9b").prefix(testCycles))
        func test_SBC_A_E_FD9B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,IYH (0xFD9C)",  arguments: loadJsonTests(named: "fd 9c").prefix(testCycles))
        func test_SBC_A_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,IYL (0xFD9D)",  arguments: loadJsonTests(named: "fd 9d").prefix(testCycles))
        func test_SBC_A_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SBC A,A (0xFD9F)",  arguments: loadJsonTests(named: "fd 9f").prefix(testCycles))
        func test_SBC_A_A_FD9F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND B (0xFDA0)",  arguments: loadJsonTests(named: "fd A0").prefix(testCycles))
        func test_AND_B_FDA0(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND C (0xFDA1)",  arguments: loadJsonTests(named: "fd a1").prefix(testCycles))
        func test_AND_C_FDA1(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND D (0xFDA2)",  arguments: loadJsonTests(named: "fd a").prefix(testCycles))
        func test_AND_D_FDA2(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND E (0xFDA3)",  arguments: loadJsonTests(named: "fd a3").prefix(testCycles))
        func test_AND_E_FDA3(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND IYH (0xFDA4)",  arguments: loadJsonTests(named: "fd a4").prefix(testCycles))
        func test_AND_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND IYL (0xFDA5)",  arguments: loadJsonTests(named: "fd a5").prefix(testCycles))
        func test_AND_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate AND A (0xFDA7)",  arguments: loadJsonTests(named: "fd a7").prefix(testCycles))
        func test_AND_A_FDA7(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR B (0xFDA8)",  arguments: loadJsonTests(named: "fd a8").prefix(testCycles))
        func test_XOR_B_FDA8(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR C (0xFDA9)",  arguments: loadJsonTests(named: "fd a9").prefix(testCycles))
        func test_XOR_C_FDA9(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR D (0xFDAA)",  arguments: loadJsonTests(named: "fd aa").prefix(testCycles))
        func test_XOR_D_FDAA(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR E (0xFDAB)",  arguments: loadJsonTests(named: "fd ab").prefix(testCycles))
        func test_XOR_E_FDAB(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR IYH (0xFDAC)",  arguments: loadJsonTests(named: "fd ac").prefix(testCycles))
        func test_XOR_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR IYL (0xFDAD)",  arguments: loadJsonTests(named: "fd ad").prefix(testCycles))
        func test_XOR_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate XOR A (0xFDAF)",  arguments: loadJsonTests(named: "fd af").prefix(testCycles))
        func test_XOR_A_FDAF(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR B (0xFDB0)",  arguments: loadJsonTests(named: "fd b0").prefix(testCycles))
        func test_OR_B_FDB0(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR C (0xFDB1)",  arguments: loadJsonTests(named: "fd b1").prefix(testCycles))
        func test_OR_C_FDB1(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR D (0xFDB2)",  arguments: loadJsonTests(named: "fd b2").prefix(testCycles))
        func test_OR_D_FDB2(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR E (0xFDB3)",  arguments: loadJsonTests(named: "fd b3").prefix(testCycles))
        func test_OR_E_FDB3(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR IYH (0xFDB4)",  arguments: loadJsonTests(named: "fd b4").prefix(testCycles))
        func test_OR_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR IYL (0xFDB5)",  arguments: loadJsonTests(named: "fd b5").prefix(testCycles))
        func test_OR_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate OR A (0xFDB7)",  arguments: loadJsonTests(named: "fd b7").prefix(testCycles))
        func test_OR_A_FDB7(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP B (0xFDB8)",  arguments: loadJsonTests(named: "fd b8").prefix(testCycles))
        func test_CP_B_FDB8(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP C (0xFDB9)",  arguments: loadJsonTests(named: "fd b9").prefix(testCycles))
        func test_CP_C_FDB9(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP D (0xFDBA)",  arguments: loadJsonTests(named: "fd ba").prefix(testCycles))
        func test_CP_D_FDBA(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP E (0xFDBB)",  arguments: loadJsonTests(named: "fd bb").prefix(testCycles))
        func test_CP_E_FDBB(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP IYH (0xFDBC)",  arguments: loadJsonTests(named: "fd bc").prefix(testCycles))
        func test_CP_IYH(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP IYL (0xFDBD)",  arguments: loadJsonTests(named: "fd bd").prefix(testCycles))
        func test_CP_IYL(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate CP A (0xFDBF)",  arguments: loadJsonTests(named: "fd bf").prefix(testCycles))
    ...
    struct UndocumentExtendedOpcodesFDCB: testHelper
    {
        ...
        @Test("Validate RLC (IY+$d),B (0xFDCB __ 00)",  arguments: loadJsonTests(named: "fd cb __ 00").prefix(testCycles))
        func test_RLC_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IY+$d),C (0xFDCB __ 01)",  arguments: loadJsonTests(named: "fd cb __ 01").prefix(testCycles))
        func test_RLC_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IY+$d),D (0xFDCB __ 02)",  arguments: loadJsonTests(named: "fd cb __ 02").prefix(testCycles))
        func test_RLC_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IY+$d),E (0xFDCB __ 03)",  arguments: loadJsonTests(named: "fd cb __ 03").prefix(testCycles))
        func test_RLC_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IY+$d),H (0xFDCB __ 04)",  arguments: loadJsonTests(named: "fd cb __ 04").prefix(testCycles))
        func test_RLC_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IY+$d),L (0xFDCB __ 05)",  arguments: loadJsonTests(named: "fd cb __ 05").prefix(testCycles))
        func test_RLC_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RLC (IY+$d),A (0xFDCB __ 07)",  arguments: loadJsonTests(named: "fd cb __ 07").prefix(testCycles))
        func test_RLC_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),B (0xFDCB __ 08)",  arguments: loadJsonTests(named: "fd cb __ 08").prefix(testCycles))
        func test_RRC_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),C (0xFDCB __ 09)",  arguments: loadJsonTests(named: "fd cb __ 09").prefix(testCycles))
        func test_RRC_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),D (0xFDCB __ 0A)",  arguments: loadJsonTests(named: "fd cb __ 0a").prefix(testCycles))
        func test_RRC_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),E (0xFDCB __ 0B)",  arguments: loadJsonTests(named: "fd cb __ 0b").prefix(testCycles))
        func test_RRC_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),H (0xFDCB __ 0C)",  arguments: loadJsonTests(named: "fd cb __ 0c").prefix(testCycles))
        func test_RRC_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),L (0xFDCB __ 0D)",  arguments: loadJsonTests(named: "fd cb __ 0d").prefix(testCycles))
        func test_RRC_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RRC (IY+$d),A (0xFDCB __ 0F)",  arguments: loadJsonTests(named: "fd cb __ 0f").prefix(testCycles))
        func test_RRC_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),B (0xFDCB __ 10)",  arguments: loadJsonTests(named: "fd cb __ 10").prefix(testCycles))
        func test_RL_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),C (0xFDCB __ 11)",  arguments: loadJsonTests(named: "fd cb __ 11").prefix(testCycles))
        func test_RL_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),D (0xFDCB __ 12)",  arguments: loadJsonTests(named: "fd cb __ 12").prefix(testCycles))
        func test_RL_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),E (0xFDCB __ 13)",  arguments: loadJsonTests(named: "fd cb __ 13").prefix(testCycles))
        func test_RL_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),H (0xFDCB __ 14)",  arguments: loadJsonTests(named: "fd cb __ 14").prefix(testCycles))
        func test_RL_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),L (0xFDCB __ 15)",  arguments: loadJsonTests(named: "fd cb __ 15").prefix(testCycles))
        func test_RL_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RL (IY+$d),A (0xFDCB __ 17)",  arguments: loadJsonTests(named: "fd cb __ 17").prefix(testCycles))
        func test_RL_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),B (0xFDCB __ 18)",  arguments: loadJsonTests(named: "fd cb __ 18").prefix(testCycles))
        func test_RR_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),C (0xFDCB __ 19)",  arguments: loadJsonTests(named: "fd cb __ 19").prefix(testCycles))
        func test_RR_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),D (0xFDCB __ 1A)",  arguments: loadJsonTests(named: "fd cb __ 1a").prefix(testCycles))
        func test_RR_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),E (0xFDCB __ 1B)",  arguments: loadJsonTests(named: "fd cb __ 1b").prefix(testCycles))
        func test_RR_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),H (0xFDCB __ 1C)",  arguments: loadJsonTests(named: "fd cb __ 1c").prefix(testCycles))
        func test_RR_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),L (0xFDCB __ 1D)",  arguments: loadJsonTests(named: "fd cb __ 1d").prefix(testCycles))
        func test_RR_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RR (IY+$d),A (0xFDCB __ 1F)",  arguments: loadJsonTests(named: "fd cb __ 1f").prefix(testCycles))
        func test_RR_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),B (0xFDCB __ 20)",  arguments: loadJsonTests(named: "fd cb __ 20").prefix(testCycles))
        func test_SLA_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),C (0xFDCB __ 21)",  arguments: loadJsonTests(named: "fd cb __ 21").prefix(testCycles))
        func test_SLA_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),D (0xFDCB __ 22)",  arguments: loadJsonTests(named: "fd cb __ 22").prefix(testCycles))
        func test_SLA_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),E (0xFDCB __ 23)",  arguments: loadJsonTests(named: "fd cb __ 23").prefix(testCycles))
        func test_SLA_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),H (0xFDCB __ 24)",  arguments: loadJsonTests(named: "fd cb __ 24").prefix(testCycles))
        func test_SLA_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),L (0xFDCB __ 25)",  arguments: loadJsonTests(named: "fd cb __ 25").prefix(testCycles))
        func test_SLA_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLA (IY+$d),A (0xFDCB __ 27)",  arguments: loadJsonTests(named: "fd cb __ 27").prefix(testCycles))
        func test_SLA_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),B (0xFDCB __ 28)",  arguments: loadJsonTests(named: "fd cb __ 28").prefix(testCycles))
        func test_SRA_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),C (0xFDCB __ 29)",  arguments: loadJsonTests(named: "fd cb __ 29").prefix(testCycles))
        func test_SRA_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),D (0xFDCB __ 2A)",  arguments: loadJsonTests(named: "fd cb __ 2a").prefix(testCycles))
        func test_SRA_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),E (0xFDCB __ 2B)",  arguments: loadJsonTests(named: "fd cb __ 2b").prefix(testCycles))
        func test_SRA_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),H (0xFDCB __ 2C)",  arguments: loadJsonTests(named: "fd cb __ 2c").prefix(testCycles))
        func test_SRA_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),L (0xFDCB __ 2D)",  arguments: loadJsonTests(named: "fd cb __ 2d").prefix(testCycles))
        func test_SRA_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRA (IY+$d),A (0xFDCB __ 2F)",  arguments: loadJsonTests(named: "fd cb __ 2f").prefix(testCycles))
        func test_SRA_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),B (0xFDCB __ 30)",  arguments: loadJsonTests(named: "fd cb __ 30").prefix(testCycles))
        func test_SLL_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),C (0xFDCB __ 31)",  arguments: loadJsonTests(named: "fd cb __ 31").prefix(testCycles))
        func test_SLL_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),D (0xFDCB __ 32)",  arguments: loadJsonTests(named: "fd cb __ 32").prefix(testCycles))
        func test_SLL_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),E (0xFDCB __ 33)",  arguments: loadJsonTests(named: "fd cb __ 33").prefix(testCycles))
        func test_SLL_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),H (0xFDCB __ 34)",  arguments: loadJsonTests(named: "fd cb __ 34").prefix(testCycles))
        func test_SLL_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),L (0xFDCB __ 35)",  arguments: loadJsonTests(named: "fd cb __ 35").prefix(testCycles))
        func test_SLL_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d) (0xFDCB __ 36)",  arguments: loadJsonTests(named: "fd cb __ 36").prefix(testCycles))
        func test_SLL_CON_IY_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SLL (IY+$d),A (0xFDCB __ 37)",  arguments: loadJsonTests(named: "fd cb __ 37").prefix(testCycles))
        func test_SLL_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),B (0xFDCB __ 38)",  arguments: loadJsonTests(named: "fd cb __ 38").prefix(testCycles))
        func test_SRL_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),C (0xFDCB __ 39)",  arguments: loadJsonTests(named: "fd cb __ 39").prefix(testCycles))
        func test_SRL_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),D (0xFDCB __ 3A)",  arguments: loadJsonTests(named: "fd cb __ 3a").prefix(testCycles))
        func test_SRL_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),E (0xFDCB __ 3B)",  arguments: loadJsonTests(named: "fd cb __ 3b").prefix(testCycles))
        func test_SRL_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),H (0xFDCB __ 3C)",  arguments: loadJsonTests(named: "fd cb __ 3c").prefix(testCycles))
        func test_SRL_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),L (0xFDCB __ 3D)",  arguments: loadJsonTests(named: "fd cb __ 3d").prefix(testCycles))
        func test_SRL_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SRL (IY+$d),A (0xFDCB __ 3F)",  arguments: loadJsonTests(named: "fd cb __ 3f").prefix(testCycles))
        func test_SRL_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 40)",  arguments: loadJsonTests(named: "fd cb __ 40").prefix(testCycles))
        func test_BIT_0_CON_IY_D_40(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 41)",  arguments: loadJsonTests(named: "fd cb __ 41").prefix(testCycles))
        func test_BIT_0_CON_IY_D_41(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 42)",  arguments: loadJsonTests(named: "fd cb __ 42").prefix(testCycles))
        func test_BIT_0_CON_IY_D_42(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 43)",  arguments: loadJsonTests(named: "fd cb __ 43").prefix(testCycles))
        func test_BIT_0_CON_IY_D_43(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 44)",  arguments: loadJsonTests(named: "fd cb __ 44").prefix(testCycles))
        func test_BIT_0_CON_IY_D_44(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 45)",  arguments: loadJsonTests(named: "fd cb __ 45").prefix(testCycles))
        func test_BIT_0_CON_IY_D_45(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 0,(IY+$d) (0xFDCB __ 47)",  arguments: loadJsonTests(named: "fd cb __ 47").prefix(testCycles))
        func test_BIT_0_CON_IY_D_47(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 48)",  arguments: loadJsonTests(named: "fd cb __ 48").prefix(testCycles))
        func test_BIT_1_CON_IY_D_48(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 49)",  arguments: loadJsonTests(named: "fd cb __ 49").prefix(testCycles))
        func test_BIT_1_CON_IY_D_49(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 4A)",  arguments: loadJsonTests(named: "fd cb __ 4a").prefix(testCycles))
        func test_BIT_1_CON_IY_D_4A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 4B)",  arguments: loadJsonTests(named: "fd cb __ 4b").prefix(testCycles))
        func test_BIT_1_CON_IY_D_4B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 4C)",  arguments: loadJsonTests(named: "fd cb __ 4c").prefix(testCycles))
        func test_BIT_1_CON_IY_D_4C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 4D)",  arguments: loadJsonTests(named: "fd cb __ 4d").prefix(testCycles))
        func test_BIT_1_CON_IY_D_4D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 1,(IY+$d) (0xFDCB __ 4F)",  arguments: loadJsonTests(named: "fd cb __ 4f").prefix(testCycles))
        func test_BIT_1_CON_IY_D_4F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 50)",  arguments: loadJsonTests(named: "fd cb __ 50").prefix(testCycles))
        func test_BIT_2_CON_IY_D_50(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 51)",  arguments: loadJsonTests(named: "fd cb __ 51").prefix(testCycles))
        func test_BIT_2_CON_IY_D_51(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 52)",  arguments: loadJsonTests(named: "fd cb __ 52").prefix(testCycles))
        func test_BIT_2_CON_IY_D_52(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 53)",  arguments: loadJsonTests(named: "fd cb __ 53").prefix(testCycles))
        func test_BIT_2_CON_IY_D_53(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 54)",  arguments: loadJsonTests(named: "fd cb __ 54").prefix(testCycles))
        func test_BIT_2_CON_IY_D_54(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 55)",  arguments: loadJsonTests(named: "fd cb __ 55").prefix(testCycles))
        func test_BIT_2_CON_IY_D_55(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 2,(IY+$d) (0xFDCB __ 57)",  arguments: loadJsonTests(named: "fd cb __ 57").prefix(testCycles))
        func test_BIT_2_CON_IY_D_57(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 58)",  arguments: loadJsonTests(named: "fd cb __ 58").prefix(testCycles))
        func test_BIT_3_CON_IY_D_58(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 59)",  arguments: loadJsonTests(named: "fd cb __ 59").prefix(testCycles))
        func test_BIT_3_CON_IY_D_59(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 5A)",  arguments: loadJsonTests(named: "fd cb __ 5a").prefix(testCycles))
        func test_BIT_3_CON_IY_D_5A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 5B)",  arguments: loadJsonTests(named: "fd cb __ 5b").prefix(testCycles))
        func test_BIT_3_CON_IY_D_5B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 5C)",  arguments: loadJsonTests(named: "fd cb __ 5c").prefix(testCycles))
        func test_BIT_3_CON_IY_D_5C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 5D)",  arguments: loadJsonTests(named: "fd cb __ 5d").prefix(testCycles))
        func test_BIT_3_CON_IY_D_5D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 3,(IY+$d) (0xFDCB __ 5F)",  arguments: loadJsonTests(named: "fd cb __ 5f").prefix(testCycles))
        func test_BIT_3_CON_IY_D_5F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 60)",  arguments: loadJsonTests(named: "fd cb __ 60").prefix(testCycles))
        func test_BIT_4_CON_IY_D_60(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 61)",  arguments: loadJsonTests(named: "fd cb __ 61").prefix(testCycles))
        func test_BIT_4_CON_IY_D_61(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 62)",  arguments: loadJsonTests(named: "fd cb __ 62").prefix(testCycles))
        func test_BIT_4_CON_IY_D_62(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 63)",  arguments: loadJsonTests(named: "fd cb __ 63").prefix(testCycles))
        func test_BIT_4_CON_IY_D_63(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 64)",  arguments: loadJsonTests(named: "fd cb __ 64").prefix(testCycles))
        func test_BIT_4_CON_IY_D_64(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 65)",  arguments: loadJsonTests(named: "fd cb __ 65").prefix(testCycles))
        func test_BIT_4_CON_IY_D_65(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 4,(IY+$d) (0xFDCB __ 67)",  arguments: loadJsonTests(named: "fd cb __ 67").prefix(testCycles))
        func test_BIT_4_CON_IY_D_67(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 68)",  arguments: loadJsonTests(named: "fd cb __ 68").prefix(testCycles))
        func test_BIT_5_CON_IY_D_68(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 69)",  arguments: loadJsonTests(named: "fd cb __ 69").prefix(testCycles))
        func test_BIT_5_CON_IY_D_69(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 6A)",  arguments: loadJsonTests(named: "fd cb __ 6a").prefix(testCycles))
        func test_BIT_5_CON_IY_6DA(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 6B)",  arguments: loadJsonTests(named: "fd cb __ 6b").prefix(testCycles))
        func test_BIT_5_CON_IY_D_6B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 6C)",  arguments: loadJsonTests(named: "fd cb __ 6c").prefix(testCycles))
        func test_BIT_5_CON_IY_D_6C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 6D)",  arguments: loadJsonTests(named: "fd cb __ 6d").prefix(testCycles))
        func test_BIT_5_CON_IY_D_6D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 5,(IY+$d) (0xFDCB __ 6F)",  arguments: loadJsonTests(named: "fd cb __ 6f").prefix(testCycles))
        func test_BIT_5_CON_IY_D_6F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 70)",  arguments: loadJsonTests(named: "fd cb __ 70").prefix(testCycles))
        func test_BIT_6_CON_IY_D_70(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 71)",  arguments: loadJsonTests(named: "fd cb __ 71").prefix(testCycles))
        func test_BIT_6_CON_IY_D_71(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 72)",  arguments: loadJsonTests(named: "fd cb __ 72").prefix(testCycles))
        func test_BIT_6_CON_IY_D_72(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 73)",  arguments: loadJsonTests(named: "fd cb __ 73").prefix(testCycles))
        func test_BIT_6_CON_IY_D_73(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 74)",  arguments: loadJsonTests(named: "fd cb __ 74").prefix(testCycles))
        func test_BIT_6_CON_IY_D_74(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 75)",  arguments: loadJsonTests(named: "fd cb __ 75").prefix(testCycles))
        func test_BIT_6_CON_IY_D_75(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 6,(IY+$d) (0xFDCB __ 77)",  arguments: loadJsonTests(named: "fd cb __ 77").prefix(testCycles))
        func test_BIT_6_CON_IY_D_77(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 78)",  arguments: loadJsonTests(named: "fd cb __ 78").prefix(testCycles))
        func test_BIT_7_CON_IY_D_78(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 79)",  arguments: loadJsonTests(named: "fd cb __ 79").prefix(testCycles))
        func test_BIT_7_CON_IY_D_79(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 7A)",  arguments: loadJsonTests(named: "fd cb __ 7a").prefix(testCycles))
        func test_BIT_7_CON_IY_D_7A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 7B)",  arguments: loadJsonTests(named: "fd cb __ 7b").prefix(testCycles))
        func test_BIT_7_CON_IY_D_7B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 7C)",  arguments: loadJsonTests(named: "fd cb __ 7c").prefix(testCycles))
        func test_BIT_7_CON_IY_D_7C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 7D)",  arguments: loadJsonTests(named: "fd cb __ 7d").prefix(testCycles))
        func test_BIT_7_CON_IY_D_7D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate BIT 7,(IY+$d) (0xFDCB __ 7F)",  arguments: loadJsonTests(named: "fd cb __ 7f").prefix(testCycles))
        func test_BIT_7_CON_IY_D_7F(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),B (0xFDCB __ 80)",  arguments: loadJsonTests(named: "fd cb __ 80").prefix(testCycles))
        func test_RES_0_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),C (0xFDCB __ 81)",  arguments: loadJsonTests(named: "fd cb __ 81").prefix(testCycles))
        func test_RES_0_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),D (0xFDCB __ 82)",  arguments: loadJsonTests(named: "fd cb __ 82").prefix(testCycles))
        func test_RES_0_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),E (0xFDCB __ 83)",  arguments: loadJsonTests(named: "fd cb __ 83").prefix(testCycles))
        func test_RES_0_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),H (0xFDCB __ 84)",  arguments: loadJsonTests(named: "fd cb __ 84").prefix(testCycles))
        func test_RES_0_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),L (0xFDCB __ 85)",  arguments: loadJsonTests(named: "fd cb __ 85").prefix(testCycles))
        func test_RES_0_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 0,(IY+$d),_A (0xFDCB __ 87)",  arguments: loadJsonTests(named: "fd cb __ 87").prefix(testCycles))
        func test_RES_0_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),B (0xFDCB __ 88)",  arguments: loadJsonTests(named: "fd cb __ 88").prefix(testCycles))
        func test_RES_1_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),C (0xFDCB __ 89)",  arguments: loadJsonTests(named: "fd cb __ 89").prefix(testCycles))
        func test_RES_1_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),D (0xFDCB __ 8A)",  arguments: loadJsonTests(named: "fd cb __ 8a").prefix(testCycles))
        func test_RES_1_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),E (0xFDCB __ 8B)",  arguments: loadJsonTests(named: "fd cb __ 8b").prefix(testCycles))
        func test_RES_1_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),H (0xFDCB __ 8C)",  arguments: loadJsonTests(named: "fd cb __ 8c").prefix(testCycles))
        func test_RES_1_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),L (0xFDCB __ 8D)",  arguments: loadJsonTests(named: "fd cb __ 8d").prefix(testCycles))
        func test_RES_1_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 1,(IY+$d),A (0xFDCB __ 8F)",  arguments: loadJsonTests(named: "fd cb __ 8f").prefix(testCycles))
        func test_RES_1_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),B (0xFDCB __ 90)",  arguments: loadJsonTests(named: "fd cb __ 90").prefix(testCycles))
        func test_RES_2_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),C (0xFDCB __ 91)",  arguments: loadJsonTests(named: "fd cb __ 91").prefix(testCycles))
        func test_RES_2_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),D (0xFDCB __ 92)",  arguments: loadJsonTests(named: "fd cb __ 92").prefix(testCycles))
        func test_RES_2_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),E (0xFDCB __ 93)",  arguments: loadJsonTests(named: "fd cb __ 93").prefix(testCycles))
        func test_RES_2_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),H (0xFDCB __ 94)",  arguments: loadJsonTests(named: "fd cb __ 94").prefix(testCycles))
        func test_RES_2_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),L (0xFDCB __ 95)",  arguments: loadJsonTests(named: "fd cb __ 95").prefix(testCycles))
        func test_RES_2_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 2,(IY+$d),A (0xFDCB __ 97)",  arguments: loadJsonTests(named: "fd cb __ 97").prefix(testCycles))
        func test_RES_2_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),B (0xFDCB __ 98)",  arguments: loadJsonTests(named: "fd cb __ 98").prefix(testCycles))
        func test_RES_3_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),C (0xFDCB __ 99)",  arguments: loadJsonTests(named: "fd cb __ 99").prefix(testCycles))
        func test_RES_3_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),D (0xFDCB __ 9A)",  arguments: loadJsonTests(named: "fd cb __ 9a").prefix(testCycles))
        func test_RES_3_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),E (0xFDCB __ 9B)",  arguments: loadJsonTests(named: "fd cb __ 9b").prefix(testCycles))
        func test_RES_3_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),H (0xFDCB __ 9C)",  arguments: loadJsonTests(named: "fd cb __ 9c").prefix(testCycles))
        func test_RES_3_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),L (0xFDCB __ 9D)",  arguments: loadJsonTests(named: "fd cb __ 9d").prefix(testCycles))
        func test_RES_3_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 3,(IY+$d),A (0xFDCB __ 9F)",  arguments: loadJsonTests(named: "fd cb __ 9f").prefix(testCycles))
        func test_RES_3_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),B (0xFDCB __ A0)",  arguments: loadJsonTests(named: "fd cb __ a0").prefix(testCycles))
        func test_RES_4_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),C (0xFDCB __ A1)",  arguments: loadJsonTests(named: "fd cb __ a1").prefix(testCycles))
        func test_RES_4_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),D (0xFDCB __ A2)",  arguments: loadJsonTests(named: "fd cb __ a2").prefix(testCycles))
        func test_RES_4_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),E (0xFDCB __ A3)",  arguments: loadJsonTests(named: "fd cb __ a3").prefix(testCycles))
        func test_RES_4_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),H (0xFDCB __ A4)",  arguments: loadJsonTests(named: "fd cb __ a4").prefix(testCycles))
        func test_RES_4_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),L (0xFDCB __ A5)",  arguments: loadJsonTests(named: "fd cb __ a5").prefix(testCycles))
        func test_RES_4_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 4,(IY+$d),A (0xFDCB __ A7)",  arguments: loadJsonTests(named: "fd cb __ a7").prefix(testCycles))
        func test_RES_4_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),B (0xFDCB __ A8)",  arguments: loadJsonTests(named: "fd cb __ a8").prefix(testCycles))
        func test_RES_5_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),C (0xFDCB __ A9)",  arguments: loadJsonTests(named: "fd cb __ a9").prefix(testCycles))
        func test_RES_5_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),D (0xFDCB __ AA)",  arguments: loadJsonTests(named: "fd cb __ aa").prefix(testCycles))
        func test_RES_5_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),E (0xFDCB __ AB)",  arguments: loadJsonTests(named: "fd cb __ ab").prefix(testCycles))
        func test_RES_5_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),H (0xFDCB __ AC)",  arguments: loadJsonTests(named: "fd cb __ ac").prefix(testCycles))
        func test_RES_5_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),L (0xFDCB __ AD)",  arguments: loadJsonTests(named: "fd cb __ ad").prefix(testCycles))
        func test_RES_5_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 5,(IY+$d),A (0xFDCB __ AF)",  arguments: loadJsonTests(named: "fd cb __ af").prefix(testCycles))
        func test_RES_5_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),B (0xFDCB __ B0)",  arguments: loadJsonTests(named: "fd cb __ b0").prefix(testCycles))
        func test_RES_6_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),C (0xFDCB __ B1)",  arguments: loadJsonTests(named: "fd cb __ b1").prefix(testCycles))
        func test_RES_6_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),D (0xFDCB __ B2)",  arguments: loadJsonTests(named: "fd cb __ b2").prefix(testCycles))
        func test_RES_6_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),E (0xFDCB __ B3)",  arguments: loadJsonTests(named: "fd cb __ b3").prefix(testCycles))
        func test_RES_6_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),H (0xFDCB __ B4)",  arguments: loadJsonTests(named: "fd cb __ b4").prefix(testCycles))
        func test_RES_6_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),L (0xFDCB __ B5)",  arguments: loadJsonTests(named: "fd cb __ b5").prefix(testCycles))
        func test_RES_6_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 6,(IY+$d),A (0xFDCB __ B7)",  arguments: loadJsonTests(named: "fd cb __ b7").prefix(testCycles))
        func test_RES_6_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),B (0xFDCB __ B8)",  arguments: loadJsonTests(named: "fd cb __ b8").prefix(testCycles))
        func test_RES_7_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),C (0xFDCB __ B9)",  arguments: loadJsonTests(named: "fd cb __ b9").prefix(testCycles))
        func test_RES_7_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),D (0xFDCB __ BA)",  arguments: loadJsonTests(named: "fd cb __ ba").prefix(testCycles))
        func test_RES_7_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),E (0xFDCB __ BB)",  arguments: loadJsonTests(named: "fd cb __ bb").prefix(testCycles))
        func test_RES_7_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),H (0xFDCB __ BC)",  arguments: loadJsonTests(named: "fd cb __ bc").prefix(testCycles))
        func test_RES_7_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),L (0xFDCB __ BD)",  arguments: loadJsonTests(named: "fd cb __ bd").prefix(testCycles))
        func test_RES_7_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate RES 7,(IY+$d),A (0xFDCB __ BF)",  arguments: loadJsonTests(named: "fd cb __ bf").prefix(testCycles))
        func test_RES_7_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),B (0xFDCB __ C0)",  arguments: loadJsonTests(named: "fd cb __ c0").prefix(testCycles))
        func test_SET_0_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),C (0xFDCB __ C1)",  arguments: loadJsonTests(named: "fd cb __ c1").prefix(testCycles))
        func test_SET_0_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),D (0xFDCB __ C2)",  arguments: loadJsonTests(named: "fd cb __ c2").prefix(testCycles))
        func test_SET_0_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),E (0xFDCB __ C3)",  arguments: loadJsonTests(named: "fd cb __ c3").prefix(testCycles))
        func test_SET_0_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),H (0xFDCB __ C4)",  arguments: loadJsonTests(named: "fd cb __ c4").prefix(testCycles))
        func test_SET_0_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),L (0xFDCB __ C5)",  arguments: loadJsonTests(named: "fd cb __ c5").prefix(testCycles))
        func test_SET_0_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 0,(IY+$d),A (0xFDCB __ C7)",  arguments: loadJsonTests(named: "fd cb __ c7").prefix(testCycles))
        func test_SET_0_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),B (0xFDCB __ C8)",  arguments: loadJsonTests(named: "fd cb __ c8").prefix(testCycles))
        func test_SET_1_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),C (0xFDCB __ C9)",  arguments: loadJsonTests(named: "fd cb __ c9").prefix(testCycles))
        func test_SET_1_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),D (0xFDCB __ CA)",  arguments: loadJsonTests(named: "fd cb __ ca").prefix(testCycles))
        func test_SET_1_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),E (0xFDCB __ CB)",  arguments: loadJsonTests(named: "fd cb __ cb").prefix(testCycles))
        func test_SET_1_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),H (0xFDCB __ CC)",  arguments: loadJsonTests(named: "fd cb __ cc").prefix(testCycles))
        func test_SET_1_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),L (0xFDCB __ CD)",  arguments: loadJsonTests(named: "fd cb __ cd").prefix(testCycles))
        func test_SET_1_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 1,(IY+$d),A (0xFDCB __ CF)",  arguments: loadJsonTests(named: "fd cb __ cf").prefix(testCycles))
        func test_SET_1_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),B (0xFDCB __ D0)",  arguments: loadJsonTests(named: "fd cb __ d0").prefix(testCycles))
        func test_SET_2_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),C (0xFDCB __ D1)",  arguments: loadJsonTests(named: "fd cb __ d1").prefix(testCycles))
        func test_SET_2_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),D (0xFDCB __ D2)",  arguments: loadJsonTests(named: "fd cb __ d2").prefix(testCycles))
        func test_SET_2_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),E (0xFDCB __ D3)",  arguments: loadJsonTests(named: "fd cb __ d3").prefix(testCycles))
        func test_SET_2_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),H (0xFDCB __ D4)",  arguments: loadJsonTests(named: "fd cb __ d4").prefix(testCycles))
        func test_SET_2_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),L (0xFDCB __ D5)",  arguments: loadJsonTests(named: "fd cb __ d5").prefix(testCycles))
        func test_SET_2_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 2,(IY+$d),A (0xFDCB __ D7)",  arguments: loadJsonTests(named: "fd cb __ d7").prefix(testCycles))
        func test_SET_2_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),B (0xFDCB __ D8)",  arguments: loadJsonTests(named: "fd cb __ d8").prefix(testCycles))
        func test_SET_3_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),C (0xFDCB __ D9)",  arguments: loadJsonTests(named: "fd cb __ d9").prefix(testCycles))
        func test_SET_3_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),D (0xFDCB __ DA)",  arguments: loadJsonTests(named: "fd cb __ da").prefix(testCycles))
        func test_SET_3_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),E (0xFDCB __ DB)",  arguments: loadJsonTests(named: "fd cb __ db").prefix(testCycles))
        func test_SET_3_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),H (0xFDCB __ DC)",  arguments: loadJsonTests(named: "fd cb __ dc").prefix(testCycles))
        func test_SET_3_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),L (0xFDCB __ DD)",  arguments: loadJsonTests(named: "fd cb __ dd").prefix(testCycles))
        func test_SET_3_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 3,(IY+$d),A (0xFDCB __ DF)",  arguments: loadJsonTests(named: "fd cb __ df").prefix(testCycles))
        func test_SET_3_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),B (0xFDCB __ E0)",  arguments: loadJsonTests(named: "fd cb __ e0").prefix(testCycles))
        func test_SET_4_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),C (0xFDCB __ E1)",  arguments: loadJsonTests(named: "fd cb __ e1").prefix(testCycles))
        func test_SET_4_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),D (0xFDCB __ E2)",  arguments: loadJsonTests(named: "fd cb __ e2").prefix(testCycles))
        func test_SET_4_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),E (0xFDCB __ E3)",  arguments: loadJsonTests(named: "fd cb __ e3").prefix(testCycles))
        func test_SET_4_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),H (0xFDCB __ E4)",  arguments: loadJsonTests(named: "fd cb __ e4").prefix(testCycles))
        func test_SET_4_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),L (0xFDCB __ E5)",  arguments: loadJsonTests(named: "fd cb __ e5").prefix(testCycles))
        func test_SET_4_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 4,(IY+$d),A (0xFDCB __ E7)",  arguments: loadJsonTests(named: "fd cb __ e7").prefix(testCycles))
        func test_SET_4_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),B (0xFDCB __ E8)",  arguments: loadJsonTests(named: "fd cb __ e8").prefix(testCycles))
        func test_SET_5_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),C (0xFDCB __ E9)",  arguments: loadJsonTests(named: "fd cb __ e9").prefix(testCycles))
        func test_SET_5_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),D (0xFDCB __ EA)",  arguments: loadJsonTests(named: "fd cb __ ea").prefix(testCycles))
        func test_SET_5_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),E (0xFDCB __ EB)",  arguments: loadJsonTests(named: "fd cb __ eb").prefix(testCycles))
        func test_SET_5_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),H (0xFDCB __ EC)",  arguments: loadJsonTests(named: "fd cb __ ec").prefix(testCycles))
        func test_SET_5_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),L (0xFDCB __ ED)",  arguments: loadJsonTests(named: "fd cb __ ed").prefix(testCycles))
        func test_SET_5_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 5,(IY+$d),A (0xFDCB __ EF)",  arguments: loadJsonTests(named: "fd cb __ ef").prefix(testCycles))
        func test_SET_5_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),B (0xFDCB __ F0)",  arguments: loadJsonTests(named: "fd cb __ f0").prefix(testCycles))
        func test_SET_6_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),C (0xFDCB __ F1)",  arguments: loadJsonTests(named: "fd cb __ f1").prefix(testCycles))
        func test_SET_6_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),D (0xFDCB __ F2)",  arguments: loadJsonTests(named: "fd cb __ f2").prefix(testCycles))
        func test_SET_6_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),E (0xFDCB __ F3)",  arguments: loadJsonTests(named: "fd cb __ f3").prefix(testCycles))
        func test_SET_6_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),H (0xFDCB __ F4)",  arguments: loadJsonTests(named: "fd cb __ f4").prefix(testCycles))
        func test_SET_6_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),L (0xFDCB __ F5)",  arguments: loadJsonTests(named: "fd cb __ f5").prefix(testCycles))
        func test_SET_6_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 6,(IY+$d),A (0xFDCB __ F7)",  arguments: loadJsonTests(named: "fd cb __ f7").prefix(testCycles))
        func test_SET_6_CON_IY_D_A(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),B (0xFDCB __ F8)",  arguments: loadJsonTests(named: "fd cb __ f8").prefix(testCycles))
        func test_SET_7_CON_IY_D_B(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),C (0xFDCB __ F9)",  arguments: loadJsonTests(named: "fd cb __ f9").prefix(testCycles))
        func test_SET_7_CON_IY_D_C(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),D (0xFDCB __ FA)",  arguments: loadJsonTests(named: "fd cb __ fa").prefix(testCycles))
        func test_SET_7_CON_IY_D_D(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),E (0xFDCB __ FB)",  arguments: loadJsonTests(named: "fd cb __ fb").prefix(testCycles))
        func test_SET_7_CON_IY_D_E(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),H (0xFDCB __ FC)",  arguments: loadJsonTests(named: "fd cb __ fc").prefix(testCycles))
        func test_SET_7_CON_IY_D_H(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),L (0xFDCB __ FD)",  arguments: loadJsonTests(named: "fd cb __ fd").prefix(testCycles))
        func test_SET_7_CON_IY_D_L(testCase: Z80Test) async throws
        {
            try await parent.runTest(testCase)
        }
        
        @Test("Validate SET 7,(IY+$d),A (0xFDCB __ FF)",  arguments: loadJsonTests(named: "fd cb __ ff").prefix(testCycles))
